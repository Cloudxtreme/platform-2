define(
	['backbone', 'Collections/Groups', 'Models/Group', 'Views/Root', 'Views/Settings'],
	function (Backbone, Groups, Group, RootView, SettingsView)
	{
		var ManageUserGroups = Backbone.View.extend({
			...
			'createGroup' : function ()
			{
				...
				Cloudwalkers.Net.post (url, {}, data, function(resp){
					if(resp.error){
						...
						RootView.growl(this.translateString("group_management"), this.translateString("group_created"));
			...
			'fillDetails' : function(group){
				...
				var group_details = new SettingsView.GroupDetails(options);
