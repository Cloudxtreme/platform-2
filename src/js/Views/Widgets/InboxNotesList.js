	...
	function (InboxMessageList, Mustache, ContactCardView, NoteEntryView, InboxNoteWidget)
	{
		var InboxNotesList = InboxMessageList.extend({
			...
			{	
				...
				for (var n in models)
				{	
					var view = new NoteEntryView ({model: models[n], template: this.entrytemplate, parameters:{inboxview: true}});
			...
			{	
				...
				this.inboxnote = new InboxNoteWidget(options);
			...
			rendercontext : function()
			{
				...
				{	
					var contactcard = new ContactCardView({contact: context});
