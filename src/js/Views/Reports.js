define(
	['Views/WidgetContainer', 'Session', 'Views/Widgets/Datepicker', 'Models/Report', 'Views/Widgets/CombinedStatistics'],
	function (WidgetContainer, Session, DatepickerWidget, ReportModel, CombinedStatisticsWidget)
	{
		var Reports = WidgetContainer.extend({
			...
			addStreamWidgets : function (stream)
			{
				...
				$.ajax 
				(
					Session.api + '/streams/' + stream.get ('id') + '/statistics',
					{
						...
						beforeSend: function(xhr){
							...
							xhr.setRequestHeader('Authorization', 'Bearer ' + Session.authenticationtoken);
						},
					}
				);
			},
			...
			addCombinedWidget : function (stream, reportsdata)
			{
				...
				var widget = new CombinedStatisticsWidget ({ 'reports' : reports, 'stream' : stream });
			...
			addReportWidget : function (stream, reportdata)
			{
				...
				var report = new ReportModel (reportdata);
