...
echo '<form method="post"><ol><li><label for="date">Date</label><input type="text" id="date" name="date" value="' . htmlentities ($date) . '" /></li><li><button type="submit">Go</button></li></ol></form>';
echo '<pre>';
