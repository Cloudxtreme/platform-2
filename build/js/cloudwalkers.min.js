var Cloudwalkers={Views:{Settings:{},Widgets:{Charts:{}}},Router:{},Models:{},Collections:{},Utilities:{},init:function(){Cloudwalkers.Session.loadEssentialData(function(){Cloudwalkers.RootView=new Cloudwalkers.Views.Root;Cloudwalkers.Router.Instance=new Cloudwalkers.Router;Backbone.history.start()})}};function AuthorizationError(a){this.name="Not Authorized";this.message=a||"Not authorized for the current user (no matching authorization token)";this.stack=Error().stack}
AuthorizationError.prototype=Error();AuthorizationError.prototype.constructor=AuthorizationError;
...
{id:this.url(),ping:Cloudwalkers.Session.getPing().cursor},this.touchlocal.bind(this))},touchlocal:function(a){a&&a.modelids.length?(this.cursor=a.cursor,this.seed(a.modelids),this.ready()):this.fetch({success:this.touchresponse.bind(this,this.url())})},touchresponse:function(a,b,c){b=c[this.parenttype][this.typestring];Store.set("touches",{id:a,modelids:b,cursor:this.cursor,ping:Cloudwalkers.Session.getPing().cursor});this.seed(b)},seed:function(a){a||(a=[]);var b=[];a=_.compact(a.map(function(a){var d=
this.get(a);d||(d=Cloudwalkers.Session.user.account[this.typestring].get(a));d?this.add(d):d=this.create({id:a});b.push(d);if(d.get("objectType")&&!d.outdated)d.stamp();else return a},this));a.length&&(this.endpoint=this.parentmodel?this.typestring:null,this.parameters={ids:a.join(",")},this.fetch({remove:!1}));this.trigger("seed",b);return b},more:function(a,b){if(!this.cursor)return!1;b.after=this.cursor;this.touch(a,b);return this},ready:function(){setTimeout(function(a){a.trigger("ready",a)},
1,this)}});Cloudwalkers.Session={user:null,isLoaded:function(){return null!=this.user},loadEssentialData:function(a){this.user=new Cloudwalkers.Models.Me;this.user.once("activated",a);this.user.fetch()},refresh:function(){console.log("Session.refresh triggered")},reset:function(){window.localStorage.clear()},home:function(){Cloudwalkers.Router.Instance.home()},updateSetting:function(a,b,c){Cloudwalkers.Session.user.attributes.settings[a]!=b&&(Cloudwalkers.Session.user.attributes.settings[a]=b,c=$.extend(c,{patch:!0})||
{patch:!0},Cloudwalkers.Session.user.save({settings:Cloudwalkers.Session.user.attributes.settings},c))},get:function(a){return this.user.get("settings")[a]},clone:function(a){if(null==a||"object"!=typeof a)return a;var b=a.constructor(),c;for(c in a)b[c]=this.clone(a[c]);return b},viewsettings:function(a,b){Cloudwalkers.Session.user.attributes.settings.viewsettings||(Cloudwalkers.Session.user.attributes.settings.viewsettings=Cloudwalkers.RootView.navigation.mapViews());var c=this.clone(this.get("viewsettings"));
if(b){if(a&&b)return c[a]=$.extend(c[a],b),this.updateSetting("viewsettings",c),c[a];throw TypeError("Not the right parameters were met for function viewsettings");}return c[a]},manage:function(){200<Store.count("messages")&&Store.filter("messages",null,function(a){a.sort(function(a,c){return a.stamp>c.stamp?1:a.stamp<c.stamp?-1:0});a=a.slice(0,100);Store.write("messages",a);Store.filter("touches",null,function(a){var c=Cloudwalkers.Session.getPing().cursor;a=a.filter(function(a){return a.ping==c});
Store.write("touches",a)})});25<Store.count("reports")&&Store.filter("reports",null,function(a){a.sort(function(a,c){return a.stamp>c.stamp?1:a.stamp<c.stamp?-1:0});a=a.slice(0,10);Store.write("messages",a)})},getPing:function(){return this.user.account.ping},ping:function(){this.user.account.ping.request()},getAccount:function(a){return a?this.user.accounts.get(a):this.user.account},getAccounts:function(a){return this.user.accounts},getChannel:function(a){return"number"==typeof a?this.user.account.channels.get(a):
this.user.account.channels.findWhere({type:a})},getChannels:function(a){return this.user.account.channels},storeChannel:function(a){a.channels&&a.channels.length&&(a.channels=a.channels.map(function(a){Cloudwalkers.Session.storeChannel(a);return a.id}));a.streams&&a.streams.length&&(a.streams=a.streams.map(function(a){Store.post("streams",a);return a.id}));Store.post("channels",a)},getStream:function(a){return"number"==typeof a?this.user.account.streams.get(a):this.user.account.streams.findWhere({token:a})},
...
getStatistic:function(a){return this.user.account.statistics.get(a)},getStatistics:function(){return this.user.account.statistics},getReport:function(a){return this.user.account.reports.get(a)},getReports:function(){return this.user.account.reports},getComment:function(a){return this.user.account.comments.get(a)},getComments:function(){return this.user.account.comments}};_.extend(Cloudwalkers.Session,Backbone.Events);Cloudwalkers.Router=Backbone.Router.extend({routes:{write:"write",share:"share","inbox(/:type)(/:streamid)":"inbox",drafts:"drafts",scheduled:"scheduled",calendar:"calendar",coworkers:"coworkers","channel/:channel(/:subchannel)(/:stream)(/:messageid)":"channel","timeline/:channel(/:stream)":"timeline","trending/:channel(/:subchannel)(/:stream)(/:messageid)":"trending","monitoring/:channel(/:subchannel)(/:messageid)":"monitoring",keywords:"managekeywords","reports/:streamid":"reports",reports:"statistics",
...
"":"delete"==a&&(this.endpoint="");return Backbone.sync(a,b,c)},getStream:function(a){var b={};b["string"==typeof a?"token":"id"]=a;return this.streams.findWhere(b)},seedcontacts:function(a){(a=a.get("from"))&&a.length&&this.contacts.add(a)}});Cloudwalkers.Models.Campaign=Backbone.Model.extend({initialize:function(){}});Cloudwalkers.Models.User=Backbone.Model.extend({initialize:function(){},url:function(){return CONFIG_BASE_URL+"json/user/"+this.id},parse:function(a){"number"==typeof a?a={id:a}:this.stamp(a);return a},filterData:function(a){var b=this.attributes;"listitem"==a?b.arrow=!0:b.role=this.getRole();return b},getRole:function(){return 10==this.get("level")?"Administrator":"Co-worker"}});Cloudwalkers.Models.Contact=Cloudwalkers.Models.User.extend({initialize:function(){}});Cloudwalkers.Models.Contact.actions={templates:{dm:{name:"Direct message",icon:"message",type:"dialog"}}};Cloudwalkers.Models.Me=Cloudwalkers.Models.User.extend({unreadMessages:null,initialize:function(a){this.once("change",this.activate);this.on("change:id",function(a){this.previous("id")&&Cloudwalkers.Session.home()})},url:function(){var a=this.endpoint?this.endpoint:Store.exists("me")?"?include_accounts=ids":"";return CONFIG_BASE_URL+"json/user/me"+a},parse:function(a){Store.exists("me")||(a.user=this.firstload(a.user));Store.write("me",[a.user]);Store.set("users",a.user);return a.user},sync:function(a,
...
this.account=this.getCurrentAccount();this.account.activate();this.level=Number(this.account.get("currentuser").level);this.trigger("activated")}.bind(this))},getCurrentAccount:function(){var a=Cloudwalkers.Session.get("currentAccount");a||(a=this.accounts.at(0).id,this.save({settings:{currentAccount:a}}));a=this.accounts.get(Number(a));return a&&a.id?a:(this.save({settings:{currentAccount:this.accounts.at(0).id}}),Cloudwalkers.Session.home())}});Cloudwalkers.Models.Stream=Backbone.Model.extend({parameters:{},initialize:function(a){this.messages=new Cloudwalkers.Collections.Messages;this.contacts=new Cloudwalkers.Collections.Contacts;this.get("statistics")&&(this.reports=new Cloudwalkers.Collections.Reports,this.reports.streamid=this.id);this.on("outdated",this.update)},outdated:function(){this.fetch()},update:function(){this.fetch()},url:function(){return CONFIG_BASE_URL+"json/streams/"+(this.id?this.id:"")+this.endpoint+this.parameters},
parse:function(a){a.stream&&(a=a.stream);this.outdated=a.outdated=!1;Store.set("streams",a);return a},sync:function(a,b,c){"read"==a?(this.endpoint=c.endpoint?"/"+c.endpoint:"",this.parameters=c.parameters?"?"+$.param(c.parameters):""):"create"==a&&(this.endpoint=c.parent?c.parent+"/streams":"");return Backbone.sync(a,b,c)},seedusers:function(a){(a=a.get("from"))&&a.length&&this.users.add(a)}});Cloudwalkers.Models.Message=Backbone.Model.extend({typestring:"messages",initialize:function(){"undefined"!=typeof this.attributes.parent&&(this.set("parentmodel",new Cloudwalkers.Models.Message(this.attributes.parent)),this.get("parentmodel").trigger("change"));this.actions=new Cloudwalkers.Collections.Actions(!1,{parent:this});this.notifications=new Cloudwalkers.Collections.Notifications(!1,{parent:this})},parse:function(a){if("number"==typeof a)return{id:a};a.message&&(a=a.message);a=this.filterData(a);
this.stamp(a);this.checkloaded(a);return a},sync:function(a,b,c){this.endpoint=c.endpoint?"/"+c.endpoint:!1;return"update"==a?!1:Backbone.sync(a,b,c)},checkloaded:function(a){a.objectType&&setTimeout(function(a){a.trigger("loaded")},1,this)},filterData:function(a){var b={};$.each("id objectType actiontokens subject body date engagement from read stream streams attachments parent statistics canHaveChildren children_count schedule".split(" "),function(c,e){b[e]=a[e]});var c=Cloudwalkers.Session.getStream(a.stream);
c&&(b.icon=c.get("network").icon,b.networktoken=c.get("network").token,b.networkdescription=c.get("name"));a.attachments?(b.media=a.attachments[a.attachments.length-1],b.media="image"==b.media.type?"picture":b.media.type,b.attached={},$.each(a.attachments,function(a,c){b.attached[c.type]=c})):b.media="reorder";a.engagement&&(b.trending=1E3>a.engagement?a.engagement:"+999");b.schedule&&(b.scheduledate=moment(b.schedule.date).format("DD MMM YYYY HH:mm"));a.body&&(b.body.intro=a.body.plaintext?a.body.plaintext.substr(0,
...
this.get("title"):this.get("body").plaintext).substring(0,b?12:16):"...";this.calNode.className=a?this.get("networktoken")+"-color":"hidden";this.calNode.networkdescription=a?this.get("networkdescription"):null;this.calNode.intro=a?this.get("body").intro:null;this.calNode.icon=a?this.get("icon"):null;this.calNode.media=b?this.get("media"):null;a&&72<=this.calNode.intro.length&&(this.calNode.intro+="...");return this},location:function(){return"#"},afterChange:function(){this.addInternalActions();
this.get("parent")&&this.get("parentmodel").set(this.get("parent"))},getActionIcon:function(a){return"internal-share"==a.token?"share-alt":"internal-edit"==a.token?"edit":"internal-delete"==a.token||"delete"==a.token?"remove":"like"==a.token?"thumbs-up":"unlike"==a.token?"thumbs-down":"comment"==a.token?"comment-alt":"reply"==a.token?"comment":"retweet"==a.token?"retweet":"dm"==a.token?"envelope":"internal-reply"==a.token?"comment":"favorite"==a.token?"star":"unfavorite"==a.token?"star-empty":a.token},
addInternalActions:function(){var a=this;if("undefined"!=typeof this.attributes.actions)for(var b=0;b<this.attributes.actions.length;b++){if("internal-"==this.attributes.actions[b].token.substr(0,9))return}else this.attributes.actions=[];"INCOMING"==this.attributes.type?this.attributes.actions.push({name:"Share",parameters:[],token:"internal-share",callback:function(a){Cloudwalkers.RootView.shareMessage(a)}}):"OUTGOING"==this.attributes.type&&(this.attributes.actions.push({name:"Edit",parameters:[],
token:"internal-edit",callback:function(b){Cloudwalkers.RootView.editMessage(a)}}),this.attributes.actions.push({name:"Delete",parameters:[],token:"internal-delete",callback:function(b){a.deleteMessage()}}));var c=this.get("parentmodel");if("undefined"!=typeof c&&c){var d=c.get("actions");if(d)for(b=0;b<d.length;b++)"comment"==d[b].token&&this.attributes.actions.push({name:"Reply",token:"internal-reply",target:c,originalaction:d[b]})}if("undefined"!=typeof this.attributes.actions)for(b=0;b<this.attributes.actions.length;b++)this.attributes.actions[b].icon=
this.getActionIcon(this.attributes.actions[b])},deleteMessage:function(){var a=this;this.repeat().repeat?Cloudwalkers.RootView.dialog("Are you sure you want to remove this message?",[{label:"Skip once",description:"Message will be skipped once",token:"skip"},{label:"Delete forever",description:"Message will never be repeated",token:"remove"}],function(b){b="post/?"+b.token+"="+a.get("id");jQuery.ajax({dataType:"json",type:"get",url:b,success:function(b){a.trigger("destroy",a,a.collection);window.location.reload()}})}):
Cloudwalkers.RootView.confirm("Are you sure you want to remove this message?",function(){a.destroy({success:function(){a.trigger("destroy",a,a.collection)}})})},humandate:function(a){a=new Date(a?a:this.get("date"));return Cloudwalkers.Utils.longdate(a)},shortdate:function(){var a=this.date();return Cloudwalkers.Utils.shortdate(a)},time:function(){var a=this.date();return Cloudwalkers.Utils.time(a)},date:function(){return new Date(this.get("date"))},getAction:function(a){for(var b=this.get("actions"),
c=0;c<b.length;c++)if(b[c].token==a)return b[c];return null},act:function(a,b,c){Cloudwalkers.RootView.growl(a.name,"The "+a.token+" is planned with success.");var d=this;"undefined"==typeof b&&(b={});a={actions:[{token:a.token,parameters:b}]};b=CONFIG_BASE_URL+"json/message/"+this.get("id")+"?account="+Cloudwalkers.Session.getAccount().get("id");jQuery.ajax({data:JSON.stringify(a),dataType:"json",type:"put",url:b,processData:!1,cache:!1,success:function(a){a.removed?d.trigger("destroy",d,d.collection):
d.set(a.message);c()}})},scheduledate:function(a){"undefined"==typeof a&&(a=!0);var b=this.get("schedule");return b?a?"ASAP"==b.date?b.date:this.humandate(b.date):"ASAP"==b.date?!1:new Date(b.date):!1},calculateIntervalFromSeconds:function(a){for(var b={},c=[{unit:"minutes",value:60},{unit:"hours",value:3600},{unit:"days",value:86400},{unit:"weeks",value:604800},{unit:"months",value:2678400}],d=c.length-1;0<=d;d--)if(0==a%c[d].value)return b.interval=Math.round(a/c[d].value),b.unit=c[d].unit,b;for(d=
0;d<c.length;d++)if(72>a/c[d].value)return b.interval=Math.round(a/c[d].value),b.unit=c[d].unit,b;return!1},repeat:function(){var a=this.get("schedule"),b={repeat:!1,weekdays:{}};if("undefined"!=typeof a&&"undefined"!=typeof a.repeat){b.repeat=!0;var c=this.calculateIntervalFromSeconds(a.repeat.interval);c&&(b.interval=c.interval,b.unit=c.unit);b.end=null;a.repeat.end&&(b.end=new Date(a.repeat.end));if(a.repeat.weekdays)for(c=0;c<a.repeat.weekdays.length;c++)b.weekdays[a.repeat.weekdays[c]]=!0}return b},
getStream:function(){return this.get("stream")?Cloudwalkers.Session.getAccount().streams.get(this.get("stream")):null},getProcessedAttachments:function(){var a=[],b;if("undefined"!=typeof this.attributes.attachments)for(var c=0;c<this.attributes.attachments.length;c++)b=this.attributes.attachments[c],"link"==b.type?null!=this.attributes.body.plaintext&&-1!==this.attributes.body.plaintext.indexOf(b.url)||a.push(b):a.push(b);return a},setRead:function(){if(!this.get("read")){var a=CONFIG_BASE_URL+"json/message/"+
this.get("id")+"/read/";jQuery.ajax({type:"get",url:a,success:function(a){}})}},shortBody:function(){var a=this.get("body");return a.plaintext?{html:a.plaintext.substring(0,100),plaintext:a.plaintext.substring(0,100)}:{html:"",plaintext:""}},messageAction:function(a){if(null==a)console.log("Action not found: "+actiontoken);else{var b=this;"undefined"!=typeof a.target&&(b=a.target,"undefined"!=typeof a.originalaction&&(a=a.originalaction));"undefined"!=typeof a.callback?a.callback(b):a&&("dialog"==
a.type?(a=new Cloudwalkers.Views.ActionParameters({message:b,action:a}),Cloudwalkers.RootView.popup(a)):"simple"==a.type?b.act(a,{},function(){}):"write"==a.type&&Cloudwalkers.RootView.writeDialog(b,a))}}});Cloudwalkers.Models.Notification=Cloudwalkers.Models.Message.extend({parse:function(a){if("number"==typeof a)return{id:a};a=this.filterData(a);this.stamp(a);return a}});Cloudwalkers.Models.Action=Backbone.Model.extend({initialize:function(a,b){this.parent=b.collection.parent},parse:function(a){this.parent&&(a=a[this.parent.get("objectType")]);return a},url:function(){var a=this.parameters?"?"+$.param(this.parameters):"",b=this.parent?this.parent.get("objectType")+"s/"+this.parent.id:"";return CONFIG_BASE_URL+"json/"+b+"/actions/"+this.get("token")+a}});Cloudwalkers.Models.Report=Backbone.Model.extend({initialize:function(a){this.entity="undefined"!=typeof a.entity?a.entity:"report";this.type="undefined"!=typeof a.type?a.type:"time";this.isFetched=!1;this.evolution=this.intervalinput=this.interval=this.display=this.daterange=null},parse:function(a){if("number"==typeof a)return{id:a};a.report&&(a=a.report);this.stamp(a);return a},stamp:function(a){a||(a={id:this.id});a.stamp=Math.round(0.0010*(new Date).getTime());Store.set("reports",a);return this},
...
this;this.isFetched=!0;$.ajax(this.getDataURL(),{success:function(c){if("undefined"==typeof c[b.entity])a(!1);else{for(var d=[],e=0;e<c[b.entity].series.length;e++)d.push({values:b.processValues(c[b.entity].series[e].values)});b.setInternalParameters(c[b.entity].series[0]);a(d)}}})},setInternalParameters:function(a){"undefined"!=typeof a.display&&(this.display=a.display);"undefined"!=typeof a.evolution&&(this.evolution=a.evolution);"undefined"!=typeof a.interval&&(this.interval=a.interval)},processValues:function(a){var b=
[],c;if(!a)return[];if("table"==this.type)return a;for(var d=0;d<a.length;d++)c="time"==this.type?(new Date(a[d].date)).getTime():"category"==this.type||"text"==this.type||"pie"==this.type?a[d].category:d,b.push([c,"text"!=this.type?parseInt(a[d].value):a[d].value]);return b}});Cloudwalkers.Models.Statistic=Backbone.Model.extend({typestring:"statistics",parameters:{},initialize:function(a){},pluck:function(a,b){var c=0;if(!this.get("streams"))return c;$.each(this.get("streams"),function(d,e){!b&&e[a]?c+=Number(e[a]):b==e.id&&(c=e[a])});return c},all:function(a){var b=[];if(!this.get("streams"))return b;$.each(this.get("streams"),function(c,d){!streamid&&d[a]?b.push(d[a]):streamid==d.id&&(b=d[a])});return b},contacts:function(a){var b=[];if(!this.get("streams"))return b;
a||$.each(this.get("streams"),function(a,d){var e=Cloudwalkers.Session.getStream(d.id);if(e){var e=e.get("network").token,f=d.contacts;f&&b.push({color:this.networkcolors[e],value:Number(f)})}}.bind(this));return b},age:function(a){return{counter:[]}},gender:function(a){return{counter:[]}},regional:function(a){return{counter:[]}},countries:function(a){return{counter:[]}},cities:function(a){return{counter:[]}},besttime:function(a){return{counter:[]}},activity:function(a){return{counter:[]}}});Cloudwalkers.Collections.Accounts=Backbone.Collection.extend({model:Cloudwalkers.Models.Account,fetch:function(a,b,c){return Cloudwalkers.Session.user.get("accounts")},updates:function(a){for(n in a){var b=this.get(a[n]);b&&(Store.set(this.typestring,{id:a[n],outdated:!0}),b.outdated=!0,b.trigger("outdated"))}},outdated:function(a){if(!a)return this.filter(function(a){return a.outdated});this.updates([a])}});Cloudwalkers.Collections.Services=Backbone.Collection.extend({model:Cloudwalkers.Models.Service,endpoint:"",parse:function(a){if(a.services)this.available=a.services.available,this.trigger("available:ready",this,a.services.available);else return a.accounts.services},url:function(){return CONFIG_BASE_URL+"json/accounts/"+Cloudwalkers.Session.getAccount().id+"/services"+this.endpoint},sync:function(a,b,c){this.endpoint=c.endpoint?"/"+c.endpoint:!1;return Backbone.sync(a,b,c)},fetchAvailable:function(a){this.fetch({endpoint:"available"})}});Cloudwalkers.Collections.Campaigns=Backbone.Collection.extend({model:Cloudwalkers.Models.Campaign,initialize:function(){this.on("destroy",this.store.bind(this,"delete"))},url:function(){return CONFIG_BASE_URL+"json/account/"+Cloudwalkers.Session.getAccount().id+"/campaigns"},parse:function(a){return a.campaigns},store:function(a,b){"delete"==a&&Store.remove("campaigns",{id:b.id})}});Cloudwalkers.Collections.Users=Backbone.Collection.extend({model:Cloudwalkers.Models.User,typestring:"users",modelstring:"user",processing:!1,initialize:function(a){a&&$.extend(this,a);Cloudwalkers.Session.user.account&&Cloudwalkers.Session.getUsers().listenTo(this,"add",Cloudwalkers.Session.getUsers().distantAdd)},parse:function(a){console.log("parsing",a);this.parentmodel&&(a=a[this.parenttype]);this.setcursor(a.paging);a.paging||this.ready();return a[this.typestring]},updates:function(a){for(n in a){var b=
this.get(a[n]);b&&(Store.set(this.typestring,{id:a[n],outdated:!0}),b.outdated=!0,b.trigger("outdated"))}},outdated:function(a){if(!a)return this.filter(function(a){return a.outdated});this.updates([a])},hook:function(a){a.records&&(this.parameters.records=a.records);this.processing?this.length&&a.success(this):this.fetch({error:a.error});this.on("sync",a.success)}});Cloudwalkers.Collections.Contacts=Cloudwalkers.Collections.Users.extend({model:Cloudwalkers.Models.Contact,typestring:"contacts",modelstring:"contact",comparator:"displayname",processing:!1,initialize:function(a,b){Cloudwalkers.Session.user.account&&Cloudwalkers.Session.getContacts().listenTo(this,"add",Cloudwalkers.Session.getContacts().distantAdd)},url:function(a){return this.endpoint?CONFIG_BASE_URL+"json/accounts/"+Cloudwalkers.Session.getAccount().id+"/"+this.typestring+"/"+this.endpoint:CONFIG_BASE_URL+
"json/accounts/"+Cloudwalkers.Session.getAccount().id+"/"+this.typestring+(this.parameters?"/"+this.parameters:"")},parse:function(a){this.parameters="";this.processing=!1;return a[this.typestring]?a[this.typestring]:a.account[this.typestring]},sync:function(a,b,c){"read"==a&&(this.processing=!0,this.parameters=c.parameters?"?"+$.param(c.parameters):"");return Backbone.sync(a,b,c)},updates:function(a){for(n in a){var b=this.get(a[n]);b&&b.get("objectType")&&(Store.set(this.typestring,{id:a[n],outdated:!0}),
...
token:"like",type:"options",toggle:"unlike"},unlike:{name:"Unlike",icon:"thumbs-down",token:"unlike",type:"options",toggle:"like"},favorite:{name:"Favorite",icon:"star",token:"favorite",type:"options",toggle:"unfavorite"},unfavorite:{name:"Unfavorite",icon:"star-empty",token:"unfavorite",type:"options",toggle:"favorite"},plusone:{name:"Unfavorite",icon:"google-plus-sign",token:"plusone",type:"options",toggle:"unplusone"},unplusone:{name:"Unfavorite",icon:"google-plus-sign",token:"unplusone",type:"options",
toggle:"plusone"}},initialize:function(a,b){b&&$.extend(this,b);this.listenTo(this.parent,"action",this.startaction)},parse:function(a){return a},url:function(){var a=this.parameters?"?"+$.param(this.parameters):"",b=this.parent?this.parent.get("objectType")+"s/"+this.parent.id:"";return CONFIG_BASE_URL+"json/"+b+"/actions"+a},rendertokens:function(a){a||(a=this.parent.get("actiontokens"));return Cloudwalkers.Session.getUser().level?a.map(function(a){return this.templates[a]}.bind(this)):[]},startaction:function(a){var b=
this.templates[a];if("confirm"==b.type)this[a](this.parent);else"options"==b.type?(this.create(b),b.toggle&&this.parent.trigger("action:toggle",a,this.templates[b.toggle]),Cloudwalkers.RootView.growl(b.name,"The "+a+" is planned with success.")):this.parent.messageAction(b)},"delete":function(a){a.deleteMessage()},like:function(){}});Cloudwalkers.Collections.Reports=Backbone.Collection.extend({model:Cloudwalkers.Models.Report,typestring:"statistics",modelstring:"report",processing:!1,parameters:{},paging:{},cursor:!1,initialize:function(a){a&&$.extend(this,a);Cloudwalkers.Session.user.account&&Cloudwalkers.Session.getReports().listenTo(this,"add",Cloudwalkers.Session.getReports().distantAdd)},distantAdd:function(a){this.get(a.id)||this.add(a)},url:function(){return CONFIG_BASE_URL+"json/stream/"+this.streamid+"/reports?complete=1"},
...
this.add(model?model:{id:a});model||(model=this.get(a));b.push(model.stamp());if(!model||!model.get("objectType")||model.outdated)return a},this));a.length&&(this.endpoint=this.parentmodel?this.typestring:null,this.parameters={ids:a.join(",")},this.fetch());this.trigger("seed",b);return b}});Cloudwalkers.Collections.Statistics=Backbone.Collection.extend({model:Cloudwalkers.Models.Statistic,typestring:"statistics",modelstring:"statistic",networkcolors:{facebook:"#3B5998",twitter:"#01a9da",linkedin:"#1783BC",tumblr:"#385775","google-plus":"#DD4C39",youtube:"#CC181E",web:"#f39501",blog:"#f39501"},colors:"#D97041 #C7604C #21323D #9D9B7F #7D4F6D #584A5E".split(" "),processing:!1,parameters:{},paging:{},cursor:!1,initialize:function(a){a&&$.extend(this,a);Cloudwalkers.Session.user.account&&
Cloudwalkers.Session.getReports().listenTo(this,"add",Cloudwalkers.Session.getReports().distantAdd)},touch:function(a,b){this.parentmodel=a;this.endpoint=this.modelstring+"ids";this.parameters=b;Store.get("touches",{id:this.url()},this.touchlocal.bind(this))},latest:function(){return this.models.slice(-1)[0]},contacts:function(a){var b=this.latest();console.log("streams",b);var c=[];if(!b.get("streams"))return c;a||$.each(b.get("streams"),function(a,b){var f=Cloudwalkers.Session.getStream(b.id);if(f){var f=
f.get("network").token,g=b.contacts;g&&c.push({color:this.networkcolors[f],value:Number(g)})}}.bind(this));console.log("contacts list:",c);return c},age:function(a){return{counter:[]}},gender:function(a){return{counter:[]}},regional:function(a){return{counter:[]}},countries:function(a){return{counter:[]}},cities:function(a){return{counter:[]}},besttime:function(a){return{counter:[]}},activity:function(a){return{counter:[]}}});Cloudwalkers.Views.Root=Backbone.View.extend({view:null,header:null,footer:null,initialize:function(){this.navigation=new Cloudwalkers.Views.Navigation;this.navigation.fit();$(window).on("resize",this.resize.bind(this));this.resize()},render:function(){$("#inner-content").html(this.view.render().el);this.view.finish&&this.view.finish();this.navigation.handleSidebarMenu()},setView:function(a){this.view&&this.view.remove();Cloudwalkers.Session.trigger("destroy:view");this.view=a;this.render();Cloudwalkers.Session.manage()},
viewshare:function(){this.share.show()},height:function(a){var b=$(window).height(),c=$(c).height();return a?c>b?c:b:b},resize:function(){var a=this.height(!0);this.trigger("resize",a);$("#inner-content").css("min-height",a-42+"px")},popup_new:function(a){var b=a.render().el,c=$(Mustache.render(Templates.popup,{title:a.title,actions:a.actions})).modal();c.find(".modal-body").html(b);if(a.actions)c.find(".modal-footer [data-action]").on("click",function(a,b){this.trigger($(b.currentTarget).data("action"),
a)}.bind(a,c));c.on("hide",function(){this.remove()}.bind(a))},popup:function(a){var b=this,c=$(Templates.uipopup).modal();c.find(".modalcontainer").html(a.render().el);a.on("popup:close",function(){c.modal("hide")});a.on("content:change",function(){b.trigger("content:change")})},writeMessage:function(a){a.preventDefault();this.setView(new Cloudwalkers.Views.Write({redirect:!1}))},editMessage:function(a){Cloudwalkers.RootView.popup(new Cloudwalkers.Views.Write({model:a.clone(),redirect:!1}))},writeDialog:function(a,
b){var c=b.parameters;"edit"==b.token?this.popup(new Cloudwalkers.Views.Write({model:a.clone(),clone:!1,redirect:!1})):this.popup(new Cloudwalkers.Views.Write({model:a.clone(),clone:!0,actionparameters:c,redirect:!1}))},shareMessage:function(a){this.popup(new Cloudwalkers.Views.Write({model:a.clone(),clone:!0,redirect:!1}))},confirm:function(a,b){var c={};c.message=a;c.options=[{token:"confirm",label:"Yes",description:"Confirm your action"}];var c=Mustache.render(Templates.uiconfirm,c),c=$(c),d=c.modal();
c.find("[data-response=confirm]").click(function(){b();d.modal("hide")})},alert:function(a,b){var c={};c.message=a;var c=Mustache.render(Templates.uiconfirm,c),c=$(c),d=c.modal();c.find("[data-response=confirm]").click(function(){b();d.modal("hide")})},growl:function(a,b){$.gritter.add({title:a,text:b,time:4E3})},information:function(a,b){$("#inner-content .container-fluid").prepend("<div class='alert alert-info'><button type='button' class='close' data-dismiss='alert'>&times;</button><strong>"+a+
"</strong> "+b+"</div>")},dialog:function(a,b,c){var d={};d.message=a;d.options=b;a=Mustache.render(Templates.uidialog,d);var e=$(a),f=e.modal();a=function(a){e.find("[data-response="+a.token+"]").click(function(){c(a);f.modal("hide")})};for(d=0;d<b.length;d++)a(b[d])},imagePopups:function(){$("a.image-popup-viewer").fancybox()}});Cloudwalkers.Views.Navigation=Backbone.View.extend({views:[{name:"dashboard",title:"Dashboard",icon:"dashboard",authorized:0},{name:"inbox",title:"Inbox",icon:"inbox",authorized:0,children:[{name:"messages",title:"Messages",icon:"envelope",authorized:0},{name:"notifications",title:"Notifications",icon:"globe",authorized:0},{name:"post",title:"Post message",icon:"pencil",url:!1,authorized:0,attributes:{"data-header-action":"post"}},{name:"drafts",title:"Drafts",icon:"edit",url:"#drafts",authorized:0},
...
authorized:0},{name:"profile",title:"Profile settings",icon:"user",authorized:0}]}],events:{"click .notification-toggle":"toggleNotifications"},initialize:function(){Cloudwalkers.Session.on("change:accounts",this.renderHeader,this);this.listenTo(Cloudwalkers.Session.getChannels(),"sync",this.render);this.listenTo(Cloudwalkers.Session.getChannels(),"remove",this.render);$.get(CONFIG_BASE_URL+"json/version",this.version.bind(this))},headeraction:function(a){a=$(a.currentTarget).data("header-action");
"messages"==a&&Cloudwalkers.Router.Instance.navigate("#inbox/messages",!0);"contacts"==a&&Cloudwalkers.Router.Instance.navigate("#coworkers",!0);"post"==a&&Cloudwalkers.RootView.popup(new Cloudwalkers.Views.Write)},fit:function(){$("#header").html(this.renderHeader().header);$("#sidebar").html(this.render().el);$("#header, #sidebar").on("click","*[data-header-action]",this.headeraction)},version:function(a){if("TESTING"==a.platform.name||"DEVELOPMENT"==a.platform.name)this.development=!0,$("#header").html(this.renderHeader().header)},
renderHeader:function(){var a={dev:this.development};a.user=Cloudwalkers.Session.user.attributes;a.accounts=[];a.level=Cloudwalkers.Session.getUser().level;Cloudwalkers.Session.user.accounts.each(function(b){a.accounts.push({name:b.get("name"),id:b.id,active:b.id==Cloudwalkers.Session.get("currentAccount")})});this.header=Mustache.render(Templates.header,a);return this},render:function(){var a=Cloudwalkers.Session.getAccount(),b={reports:[]};b.level=Cloudwalkers.Session.getUser().level;if(b.level){var c=
a.channels.findWhere({type:"news"});b.news={channelid:c.id,streams:c.streams.models,name:c.get("name")};c=a.channels.findWhere({type:"monitoring"});b.monitoring={channelid:c.id,channels:c.channels.models,name:c.get("name")}}b.scheduled={channelid:Cloudwalkers.Session.getChannel("internal").id};b.scheduled.streams=a.streams.where({outgoing:1});b.inbox=!0;c=a.channels.findWhere({type:"profiles"});b.profiles={channelid:c.id,streams:c.streams.models,name:c.get("name")};b.reports=a.streams.where({statistics:1}).map(function(a){return a.attributes});
this.$el.html(Mustache.render(Templates.navigation,b));this.handleSidebarMenu();return this},handleSidebarMenu:function(){var a=Backbone.history.fragment;if(!a)return null;this.setActive(a)},setActive:function(a){$("#sidebar .active").removeClass("active");$('a[href="#'+a+'"]').parents("#sidebar .page-sidebar-menu *").addClass("active")},setNotifications:function(a){this.$el.find(".popup-frame ul").html("");for(var b=0;b<a.length;b++)this.addNotification(a[b])},addNotification:function(a){this.$el.find(".popup-frame ul").append('<li><div class="text account"><p>'+
a.message+'</p><div class="row"><span class="time"></span></div></div></li>')},toggleNotifications:function(){this.$el.find(".notification-popup").toggle()},mapViews:function(){var a={};for(n in this.views)if(a[this.views[n].name]={streams:[]},this.views[n].children)for(i in this.views[n].children)a[this.views[n].children[i].name]={streams:[]};return a}});Cloudwalkers.Views.Share=Backbone.View.extend({events:{"click .notification-toggle":"toggleNotifications"},initialize:function(){},fit:function(){$("#share").html(this.render().el)},render:function(){this.$el.html(Mustache.render(Templates.share,{streams:[{icon:"twitter",name:"bmgroup"},{icon:"facebook",name:"bmgroup"},{icon:"linkedin",name:"Cloudwalkers"}]}));return this},show:function(){$("#share").removeClass("collapsed");$("#sidebar, #inner-content").addClass("collapsed");this.spanheight()},hide:function(){$("#share").addClass("collapsed");
...
this.$container.append(Templates.row);this.span=12>b+this.span?b+this.span:0;this.$container.children().last().append(a.render().el);this.widgetviews.push(a);a.$el.addClass("span"+b);a.negotiateFunctionalities()},appendhtml:function(a){this.$container.children().last().append(a)},cleanviews:function(){this.widgetviews.length&&(this.destroy(),this.widgetviews=[])},destroy:function(){$.each(this.widgetviews,function(a,b){b.remove()})}});Cloudwalkers.Views.Message=Backbone.View.extend({events:{"click .message-action[data-action]":"messageAction","click .children-button.message-children":"showchildren"},className:"message-view",template:"message",tagName:"tr",commentsVisible:!1,commentsView:null,childrencontainer:"comment-container",initialize:function(){var a=this;this.model.on("change",function(){a.render()})},prepareData:function(){var a=jQuery.extend(!0,{},this.model.attributes);a.shortBody=this.model.shortBody();a.humandate=this.model.humandate();
...
this.appendWidget(a,4);var b=new Cloudwalkers.Views.Widgets.ScheduledList({model:this.model});this.appendWidget(b,8);a.list=b;return this}});Cloudwalkers.Views.Calendar=Cloudwalkers.Views.Pageview.extend({title:"Calendar",className:"container-fluid calendar",events:{remove:"destroy","change select":"toggleView","click #subtract":"prev","click #add":"next"},initialize:function(){this.model=Cloudwalkers.Session.getChannel("profiles");if(!this.model)return Cloudwalkers.Session.home();this.listenTo(this.model,"sync",this.render)},render:function(){this.$el.html(Mustache.render(Templates.calendar,{monthActive:!0}));this.$container=this.$el.find("#widgetcontainer").eq(0);
this.$el.find("select").chosen({width:"200px",disable_search_threshold:10,inherit_select_classes:!0});setTimeout(this.initCalendar.bind(this),10);return this},populate:function(a,b,c,d){this.listenToOnce(this.model.messages,"ready",this.fill.bind(this,d));this.listenToOnce(this.model.messages,"ready",function(){console.log("triggered Ready")});this.model.messages.touch(this.model,{records:999,since:a.unix(),until:b.unix()})},fill:function(a,b){var c=[];for(n in b.models)c.push(b.models[n].filterCalReadable().calNode);
a(c)},updatenode:function(a,b){$("#calendar").fullCalendar("updateEvent",a.filterCalReadable().calNode)},filldrafts:function(a){$("#drafts-list").html("");for(n in a)this.addDraft("Draft message ("+a[n].id+")")},toggleView:function(a){$("#calendar").fullCalendar("changeView",$(a.currentTarget).val())},prev:function(){$("#calendar").fullCalendar("prev")},next:function(){$("#calendar").fullCalendar("next")},initCalendar:function(){$("#calendar").fullCalendar({header:!1,slotMinutes:30,editable:!1,droppable:!1,
allDayDefault:!1,allDaySlot:!1,axisFormat:"H:mm",defaultTimedEventDuration:"00:30:00",slotEventOverlap:!1,events:this.populate.bind(this),eventRender:function(a,b){if(!a.icon)return!1;$(b).find(".fc-event-time").html("<i class='icon-"+a.icon+"'></i>");a.media&&$(b).find(".fc-event-inner").prepend("<i class='fc-event-media pull-right icon-"+a.media+"'></i>");$(b).data("title",a.intro).tooltip({html:!0,delay:500,placement:"top"});a.rendered=!0}})},addDraft:function(a){a=0==a.length?"Untitled Event":
...
c.push(f)}c=new Cloudwalkers.Views.Widgets.CombinedStatistics({reports:c,stream:a});c.color=a.network.icon+"-color";c.network=a.network;this.add(c)},addReportWidget:function(a,b){b.stream=a;var c=new Cloudwalkers.Models.Report(b),d=c.getWidget(),e=this.datepicker.getDateRange();c.setDateRange(e[0],e[1]);d.color=a.network.icon+"-color";d.network=a.network;d.showLink=!1;d.showStreamName=!1;this.datepicker.on("date:change",function(a,b){d.getDataset().setDateRange(a,b)});this.add(d)}});Cloudwalkers.Views.Statistics=Cloudwalkers.Views.Pageview.extend({id:"statistics",start:0,end:0,timespan:"week",period:0,custom:!1,views:[],events:{remove:"destroy","click #add":"addperiod","click #subtract":"subtractperiod","click #now":"changespan","click #show":"changecustom","change .stats-header select":"changespan"},widgets:[{widget:"StatSummary",data:{columnviews:["contacts","score-trending","outgoing","coworkers"]},span:12},{widget:"Chart",data:{filterfunc:"contacts",chart:"PolarArea",title:"Contacts"},
span:6},{widget:"Chart",data:{filterfunc:"age",chart:"Doughnut",title:"By Age"},span:3},{widget:"Chart",data:{filterfunc:"gender",chart:"Doughnut",title:"By Gender"},span:3},{widget:"Info",data:{title:"Contact Evolution"},span:3},{widget:"Info",data:{title:"Post Activity"},span:3},{widget:"Info",data:{title:"Activity?"},span:3},{widget:"Info",data:{title:"Page Views?"},span:3},{widget:"Chart",data:{filterfunc:"regional",chart:"PolarArea",title:"Regional Popularity"},span:6},{widget:"Legenda",data:{},
span:3},{widget:"Combo",data:{widgets:[{widget:"Chart",data:{filterfunc:"countries",chart:"Doughnut",title:"Countries"},span:12},{widget:"Chart",data:{filterfunc:"cities",chart:"Doughnut",title:"Cities"},span:12}]},span:3},{widget:"Chart",data:{filterfunc:"besttime",chart:"Line",title:"Best Time to Post"},span:6},{widget:"HeatCalendar",data:{filterfunc:"activity",title:"Activity Calendar"},span:6}],initialize:function(a){a&&$.extend(this,a);this.model.statistics||(this.model.statistics=new Cloudwalkers.Collections.Statistics);
this.collection=this.model.statistics;this.listenTo(this.collection,"request",this.showloading);this.listenTo(this.collection,"ready",this.hideloading)},showloading:function(){this.$el.addClass("loading")},hideloading:function(a,b){this.$el.removeClass("loading")},render:function(){this.cleanviews();this.$el.html(Mustache.render(Templates.statsview,this.timemanager()));this.$container=this.$el.find("#widgetcontainer").eq(0);this.$el.find("select").chosen({width:"200px",disable_search_threshold:10,
inherit_select_classes:!0});"custom"==this.timespan&&this.$el.find("#start, #end").datepicker({format:"dd-mm-yyyy"});for(n in this.widgets){this.widgets[n].data.model=this.model;var a=new Cloudwalkers.Views.Widgets[this.widgets[n].widget](this.widgets[n].data);this.views.push(a);this.appendWidget(a,this.widgets[n].span)}this.collection.touch(this.model,this.filterparameters());return this},timemanager:function(){var a=this.filterparameters(),b=moment.unix(a.since),c=24<b.date()||"quarter"==a.span?
11==b.month()?"DD MMM YYYY":"DD MMM":"DD";a.periodstring=this.period||"custom"==a.span?-1==this.period?"last ":"":"this ";a.timeview=b.format(c)+" - "+moment.unix(a.until).format("DD MMM YYYY");a[a.span+"Active"]=!0;a.startstring=moment.unix(a.since).format("DD-MM-YYYY");a.endstring=moment.unix(a.until).format("DD-MM-YYYY");return a},addperiod:function(){this.period+=1;this.render()},subtractperiod:function(){this.period-=1;this.render()},changespan:function(){this.period=0;this.render()},changecustom:function(){this.start=
moment(this.$el.find("#start").val(),"DD-MM-YYYY");this.end=moment(this.$el.find("#end").val(),"DD-MM-YYYY");this.render()},filterparameters:function(){var a=this.$el.find(".stats-header select").val();a&&(this.timespan=a);"now"==this.timespan&&(this.period=0);"week"==this.timespan&&(this.start=moment().startOf("week"),this.end=moment().endOf("week"));"month"==this.timespan&&(this.start=moment().startOf("month"),this.end=moment().endOf("month"));"year"==this.timespan&&(this.start=moment().startOf("year"),
this.end=moment().endOf("year"));"quarter"==this.timespan?(a=3*(this.period+moment().quarter()),this.start=moment().startOf("year").add("months",a-3),this.end=moment().startOf("year").add("months",a-1).endOf("month")):"custom"!=this.timespan&&(0<this.period&&(this.start.add(this.timespan+"s",this.period),this.end.add(this.timespan+"s",this.period)),0>this.period&&(this.start.subtract(this.timespan+"s",Math.abs(this.period)),this.end.subtract(this.timespan+"s",Math.abs(this.period))));return{since:this.start.unix(),
until:this.end.unix(),span:this.timespan,period:this.period}},finish:function(){}});Cloudwalkers.Views.Settings=Cloudwalkers.Views.Pageview.extend({title:"Settings",tabs:[],initialize:function(){this.endpoint=this.options.endpoint;this.level=Cloudwalkers.Session.user.level},setAction:function(a){this.action=a},render:function(){this.level&&(this.tabs=[{url:"#settings/users",name:"Manage users"},{url:"#settings/services",name:"Social connections"},{url:"#settings/account",name:"Account settings"}]);this.tabs.push({url:"#settings/profile",name:"Profile settings"});this.$el.html(Mustache.render(Templates.tabview,
...
a)},toggleaction:function(a,b){var c=this.$el.find('div[data-notification-action="'+a+'"]'),d=c.clone();d.attr("data-notification-action",b.token).find("i").attr("class","").addClass("icon-"+b.icon);c.before(d).remove()},toggleactions:function(a){a="mouseout"==a.originalEvent.type;this.$el.find(".message-actions")[a?"addClass":"removeClass"]("hidden");this.$el.find(".comment-info")[a?"removeClass":"addClass"]("hidden")},markasread:function(){this.model.save({read:1},{patch:!0,wait:!0});this.model.get("stream")&&
Cloudwalkers.Session.getStreams().outdated(this.model.get("stream"))}});Cloudwalkers.Views.Widgets.Chart=Backbone.View.extend({title:"Chart",events:{},initialize:function(a){a&&$.extend(this,a);this.listenTo(this.model.statistics,"ready",this.fill)},render:function(){this.$el.html(Mustache.render(Templates.chart,{title:this.title}));this.canvas=this.$el.find("canvas").get(0).getContext("2d");var a=this.parse[this.chart]();(new Chart(this.canvas))[this.chart](a);return this},fill:function(a){this.parse.collection=a;a=this.parse[this.chart](this.model,this.filterfunc);
(new Chart(this.canvas))[this.chart](a)},parse:{PolarArea:function(a,b){return a?this.collection[b]():[{value:50,color:"#ffffff"},{value:100,color:"#f9f9f9"}]},Doughnut:function(a,b){return a?this.collection.latest()[b]():[{value:50,color:"#f7f7f7"},{value:50,color:"#fafafa"}]},Line:function(a){return a?{labels:"January February March April May June July".split(" "),datasets:[{fillColor:"rgba(220,220,220,0.5)",strokeColor:"rgba(220,220,220,1)",pointColor:"rgba(220,220,220,1)",pointStrokeColor:"#fff",
data:[65,59,90,81,56,55,40]},{fillColor:"rgba(151,187,205,0.5)",strokeColor:"rgba(151,187,205,1)",pointColor:"rgba(151,187,205,1)",pointStrokeColor:"#fff",data:[28,48,40,19,96,27,100]}]}:{labels:["",""],datasets:[{fillColor:"rgba(220,220,220, .1)",pointStrokeColor:"#fff",data:[1,100]}]}}},negotiateFunctionalities:function(){}});Cloudwalkers.Views.Widgets.Info=Backbone.View.extend({title:"Info",initialize:function(a){a&&$.extend(this,a);this.listenTo(this.model,"change",this.render)},render:function(){this.$el.html(Mustache.render(Templates.dashboardstat,{title:this.title}));return this},negotiateFunctionalities:function(){}});Cloudwalkers.Views.Widgets.Combo=Backbone.View.extend({render:function(){this.$el.html("<div>Combo</div>");return this},negotiateFunctionalities:function(){}});Cloudwalkers.Views.Widgets.Legenda=Backbone.View.extend({title:"Info",initialize:function(a){a&&$.extend(this,a);this.listenTo(this.model,"change",this.render)},render:function(){this.$el.html("<div></div>");return this},negotiateFunctionalities:function(){}});Cloudwalkers.Views.Widgets.HeatCalendar=Backbone.View.extend({title:"Info",initialize:function(a){a&&$.extend(this,a);this.listenTo(this.model,"change",this.render)},render:function(){this.$el.html("<div></div>");return this},negotiateFunctionalities:function(){}});Cloudwalkers.Views.Widgets.MessageContainer=Cloudwalkers.Views.Widgets.Widget.extend({template:"messagecontainer",messageelement:"tr",canLoadMore:!0,events:{"click .load-more a":"loadMore"},initialize:function(){this.title=this.options.channel.name;this.canLoadMore="undefined"==typeof this.options.channel.canLoadMore?!0:this.options.channel.canLoadMore;this.initializeWidget()},refreshWidget:function(a){a.preventDefault();this.options.channel.update()},innerRender:function(a){var b=this,c={};jQuery.extend(!0,
...
{name:this.category.get("name")}));this.$container=this.$el.find(".messages-container");this.$el.find(".load-more").hide();this.category.messages.touch(this.category,this.parameters);return this},showloading:function(){this.$el.find(".icon-cloud-download").show();this.$el.find(".load-more").hide()},hideloading:function(){this.$el.find(".icon-cloud-download").hide();this.category.messages.cursor&&this.$el.find(".load-more").show();this.$container.removeClass("inner-loading")},fill:function(a){this.incremental?
...
$.extend(a,this.options);this.list&&(this.list.comparator=function(a,c){return c.count-a.count},this.list.sort(),this.list.each(function(b){var c=b.attributes,d=a.typelink?a.typelink+"/"+(b.get("hasMessages")?"messages":"notifications"):a.link?a.link:"#"+a.type+"/"+a.channel.id+"/"+b.id;a.list.push({id:c.id,name:c.name,url:d,count:b.count,icon:c.network?c.network.icon:a.icon})}));this.$el.html(Mustache.render(Templates.messagescounters,a));return this},updatesettings:function(a){if("streams"!=this.options.source)return null;
