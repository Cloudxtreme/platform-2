...
parseInt(this.counters[i].amount));this.list.models[n].count=this.keywordchannels[k].streams.models.get("counters").recent.incoming.any.unread}this.trigger("view:update")},render:function(){var a={list:[]};$.extend(a,this.options);this.list&&(this.list.comparator=function(a,c){return c.count==a.count?c.id-a.id:c.count-a.count},this.list.sort(),this.list.each(function(b){var c=b.attributes,e=a.typelink?a.typelink+"/"+(b.get("hasMessages")?"messages":"notifications"):a.link?a.link:"#"+a.type+"/"+a.channel.id+
"/"+b.id;a.list.push({id:c.id,name:c.name,url:e,count:b.count,icon:c.network?c.network.icon:a.icon})}));this.$el.html(Mustache.render(Templates.messagescounters,a));return this},updatesettings:function(a){if("streams"!=this.options.source&&"outgoing"!=this.options.source)return null;a=this.list.get($(a.currentTarget).data("stream"));var b=a.get("childtypes")[0]+"s";"outgoing"==this.options.channel.get("type")&&(b="scheduled");var c=Cloudwalkers.Session.viewsettings(b);c.streams=[a.id];Cloudwalkers.Session.viewsettings(b,
c)},negotiateFunctionalities:function(){this.$el.find(".scroller").length&&this.addScroll();this.options.counter&&this.appendCounter();"undefined"!=typeof this.options.open&&this.appendCollapseble(this.options.open)}});Cloudwalkers.Views.Widgets.CombinedStatistics=Cloudwalkers.Views.Widgets.Widget.extend({size:"full",currentReport:null,element:null,render:function(){function a(a){f.find('[data-report-id="'+a.get("uniqueid")+'"]').click(function(){c.setReport(a)})}function b(a){f.find('[data-interval-id="'+a.token+'"]').click(function(){f.find(".interval-value").html(a.name);var b=1;"day"==a.token?b=11:"7days"==a.token?b=77:"28days"==a.token&&(b=308);for(var e=new Date,e=new Date(e.getFullYear(),e.getMonth(),e.getDate()+
