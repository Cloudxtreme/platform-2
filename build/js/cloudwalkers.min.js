...
this.get(a);e||(e=Cloudwalkers.Session.user.account[this.typestring].get(a));e?this.add(e):e=this.create({id:a});b.push(e);return a},this));a.length&&(this.endpoint=this.parentmodel?this.typestring:null,this.parameters={ids:a.join(",")},this.fetch({remove:!1}));this.trigger("seed",b);return b},more:function(a,b){if(!this.cursor)return!1;b.after=this.cursor;this.touch(a,b);return this},ready:function(){setTimeout(function(a){a.trigger("ready",a)},1,this)}});Cloudwalkers.Session={langs:[{id:"en_EN",name:"International English"},{id:"nl_NL",name:"Nederlands"},{id:"pt_PT",name:"Portugu\u00eas"}],user:null,version:"1.0.0.0",localversion:null,isLoaded:function(){return null!=this.user},loadEssentialData:function(a){this.user=new Cloudwalkers.Models.Me;this.getversion();this.user.once("activated",function(){this.setLang()}.bind(this));this.listenTo(this,"translation:done",a);this.user.fetch({error:this.user.offline.bind(this.user)})},refresh:function(){console.log("Session.refresh triggered")},
reset:function(){window.localStorage.clear()},home:function(){Cloudwalkers.Router.Instance.home()},updateSetting:function(a,b,c){Cloudwalkers.Session.user.attributes.settings[a]!=b&&(Cloudwalkers.Session.user.attributes.settings[a]=b,c=$.extend(c,{patch:!0})||{patch:!0},Cloudwalkers.Session.user.save({settings:Cloudwalkers.Session.user.attributes.settings},c))},get:function(a){return this.user.get("settings")[a]},clone:function(a){if(null==a||"object"!=typeof a)return a;var b=a.constructor(),c;for(c in a)b[c]=
this.clone(a[c]);return b},viewsettings:function(a,b){var c="account_"+this.getAccount().id;Cloudwalkers.Session.user.attributes.settings.viewsettings||(Cloudwalkers.Session.user.attributes.settings.viewsettings={});Cloudwalkers.Session.user.attributes.settings.viewsettings[c]||(Cloudwalkers.Session.user.attributes.settings.viewsettings[c]=Cloudwalkers.RootView.navigation.mapViews());var e=this.clone(this.get("viewsettings"));if(b){if(a&&b)return e[c][a]=$.extend(e[c][a],b),this.updateSetting("viewsettings",
e),e[c][a];throw TypeError("Not the right parameters were met for function viewsettings");}return e[c][a]},manage:function(){200<Store.count("messages")&&Store.filter("messages",null,function(a){a.sort(function(a,c){return a.stamp>c.stamp?1:a.stamp<c.stamp?-1:0});a=a.slice(0,100);Store.write("messages",a);Store.filter("touches",null,function(a){var c=Cloudwalkers.Session.getPing().cursor;a=a.filter(function(a){return a.ping==c});Store.write("touches",a)})});25<Store.count("reports")&&Store.filter("reports",
null,function(a){a.sort(function(a,c){return a.stamp>c.stamp?1:a.stamp<c.stamp?-1:0});a=a.slice(0,10);Store.write("messages",a)})},getversion:function(){Store.get("version",null,function(a){a&&(this.localversion=a.version)}.bind(this))},isupdated:function(){return this.localversion?this.localversion==this.version:!1},isAuthorized:function(a){return a?this.user.isauthorized(a):this.user.authorized},censuretemplate:function(a){a||(a={});var b=this.getUser().censuretokens;a.authorized=b},getPing:function(){return this.user.account.ping},
ping:function(){this.user.account.ping.forceping()},getAccount:function(a){return a?this.user.accounts.get(a):this.user.account},getAccounts:function(a){return this.user.accounts},getChannel:function(a){return"number"==typeof a?this.user.account.channels.get(a):this.user.account.channels.findWhere({type:a})},getChannels:function(a){return this.user.account.channels},storeChannel:function(a){a.channels&&a.channels.length&&(a.channels=a.channels.map(function(a){Cloudwalkers.Session.storeChannel(a);
return a.id}));a.streams&&a.streams.length&&(a.streams=a.streams.map(function(a){Store.post("streams",a);return a.id}));Store.post("channels",a)},getStream:function(a){return"number"==typeof a?this.user.account.streams.get(a):this.user.account.streams.findWhere({token:a})},getStreams:function(){return this.user.account.streams},getUser:function(a){return a?this.user.account.users.get(a):this.user},getUsers:function(){return this.user.account.users},getContact:function(a){return this.user.account.contacts.get(a)},
getContacts:function(){return this.user.account.contacts},getMessage:function(a){return this.user.account.messages.get(a)},getMessages:function(){return this.user.account.messages},getCannedResponse:function(a){return this.user.account.cannedresponses.get(a)},getCannedResponses:function(){return this.user.account.cannedresponses},getNotification:function(a){return this.user.account.notifications.get(a)},getNotifications:function(){return this.user.account.notifications},getStatistic:function(a){return this.user.account.statistics.get(a)},
getStatistics:function(){return this.user.account.statistics},getReport:function(a){return this.user.account.reports.get(a)},getReports:function(){return this.user.account.reports},getComment:function(a){return this.user.account.comments.get(a)},getComments:function(){return this.user.account.comments},setLang:function(a){var b;moment.lang(this.user.attributes.locale);b=new Cloudwalkers.Models.Polyglot;b.fetch({success:function(){this.translationLang=b.get("translation");this.polyglot=new Polyglot({phrases:this.translationLang});
...
this.validate(a,"STATISTICS_VIEW")},settings:function(a){var b;"users"==a&&(b="USER_INVITE");"services"==a&&(b="SERVICE_CONNECT");"account"==a&&(b="CAMPAIGN_DELETE");a=new Cloudwalkers.Views.Settings({endpoint:a});this.validate(a,b)},firsttime:function(){Cloudwalkers.RootView.setView(new Cloudwalkers.Views.Firsttime)},coworkdashboard:function(){Cloudwalkers.RootView.setView(new Cloudwalkers.Views.Coworkdashboard)},manageusergroups:function(){Cloudwalkers.RootView.setView(new Cloudwalkers.Views.ManageUserGroups)},
resync:function(a){this.navigate("#resync");Cloudwalkers.RootView.setView(new Cloudwalkers.Views.Resync({returnto:a}))},home:function(){Cloudwalkers.Session.reset();window.location="/";return!1},validate:function(a,b){if(!Cloudwalkers.Session.isupdated())return Cloudwalkers.RootView.resync("#"+Backbone.history.fragment);Cloudwalkers.Session.isAuthorized(b)?Cloudwalkers.RootView.setView(a):window.location="/"},exception:function(a){var b="/";switch(a){case 401:case 503:b="/503.html";default:window.location=
b}}});Cloudwalkers.Session.Ping=Backbone.Model.extend({interval:3E4,min:1E4,max:9E4,timeout:0,cursor:!1,parameters:{},initialize:function(){Store.exists("ping",{id:this.id})||Store.post("ping",{id:this.id});this.setCursor(!1);this.fetch({success:this.schedule.bind(this),error:this.toing});this.on("change:paging",this.setCursor,this);this.on("change:updates",this.updateModels,this);this.on("change:add",this.addModels,this);this.on("change:remove",this.removeModels,this);this.listenTo(Cloudwalkers.Session,
...
"":"delete"==a&&(this.endpoint="");return Backbone.sync(a,b,c)},getStream:function(a){var b={};b["string"==typeof a?"token":"id"]=a;return this.streams.findWhere(b)},seedcontacts:function(a){(a=a.get("from"))&&a.length&&this.contacts.add(a)}});Cloudwalkers.Models.Campaign=Backbone.Model.extend({initialize:function(){}});Cloudwalkers.Models.User=Backbone.Model.extend({typestring:"users",initialize:function(){},url:function(){return this.parent?CONFIG_BASE_URL+"json/"+this.parent.typestring+"/"+this.parent.id+"/"+this.typestring+"/"+this.id:CONFIG_BASE_URL+"json/user/"+this.id},parse:function(a){"number"==typeof a?a={id:a}:this.stamp(a);return a},filterData:function(a){var b=this.attributes;"listitem"==a?b.arrow=!0:b.role=this.getRole();return b},getcoworker:function(a){},getRole:function(){var a=Cloudwalkers.Session.getAccount().get("roles"),
b=this.get("rolegroup");if(!a||_.isUndefined(b))return Cloudwalkers.RootView.resync("#"+Backbone.history.fragment);a=a.filter(function(a){return a.id==b});return a.length?a[0]:null}});Cloudwalkers.Models.Contact=Cloudwalkers.Models.User.extend({typestring:"contacts",modelstring:"contact",url:function(){var a=[CONFIG_BASE_URL+"json"];this.parent?a.push(this.parent.typestring,this.parent.id,this.typestring,this.id):this.id?a.push("accounts",Cloudwalkers.Session.getAccount().id,this.typestring,this.id):a.push("accounts",Cloudwalkers.Session.getAccount().id,this.typestring);this.urlparams&&(a=a.concat(this.urlparams));a=a.join("/");return this.parameters?a+"?"+$.param(this.parameters):
...
moment(a.date).format("HH:mm"),a.type_icon=this.type_settings[a.model.objectType].icon,a.model&&(a.objectType="note"));return a},attachParent:function(a,b){a=this.type_settings[a].model;var c=Cloudwalkers.Session["get"+a](b);c||(c=new Cloudwalkers.Models[a]({id:b}),c.fetch());return c},url:function(){var a=[CONFIG_BASE_URL+"json"];this.id?a.push(this.typestring,this.id):this.parent?"contacts"!=this.parent.typestring?a.push(this.parent.typestring,this.parent.id,this.typestring):"contacts"==this.parent.typestring&&
(a.push("accounts/"+Cloudwalkers.Session.getAccount().id+"/contacts"),a.push(this.parent.id),a.push(this.typestring)):a.push(this.typestring);a=a.join("/");return this.parameters?a+"?"+$.param(this.parameters):a},action:function(a){"delete"==a&&this.deletenote()},deletenote:function(){var a=this;Cloudwalkers.RootView.confirm("Are you sure you want to remove this note?",function(){a.destroy({success:function(){a.trigger("destroy")}})})}});Cloudwalkers.Models.Tag=Backbone.Model.extend({typestring:"tags",initialize:function(a){a&&$.extend(this,a);this.on("action",this.action)},parse:function(a){a=a.tag?a.tag:a;a.date&&(a.fulldate=moment(a.date).format("DD MMM YYYY HH:mm"),a.dateonly=moment(a.date).format("DD MMM YYYY"),a.time=moment(a.date).format("HH:mm"));return a},url:function(){var a=[CONFIG_BASE_URL+"json"];"contacts"==this.parent.typestring&&a.push("accounts/"+Cloudwalkers.Session.getAccount().id);"tags"==this.typestring&&this.id?
...
"json/"+this.typestring+"/"+this.id+this.endpoint:CONFIG_BASE_URL+"json/"+this.typestring+"/"+this.id:(a=this.parameters,this.endpoint?CONFIG_BASE_URL+"json/accounts/"+Cloudwalkers.Session.getAccount().id+"/"+this.typestring+this.endpoint+a:CONFIG_BASE_URL+"json/accounts/"+Cloudwalkers.Session.getAccount().id+"/"+this.typestring)},parse:function(a){if("number"==typeof a)return{id:a};a.message&&(a=a.message);a=this.filterData(a);this.stamp(a);this.checkloaded(a);return a},sync:function(a,b,c){this.endpoint=
c.endpoint?"/"+c.endpoint:!1;return"update"==a?!1:Backbone.sync(a,b,c)},validateCustom:function(a){var b;if(!this.hascontent()&&0>$.inArray("content",a))return"You need a bit of content.";if(!this.validatecontent())return"One or more networks exceed the character limit.";if(!this.get("streams").length&&0>$.inArray("streams",a))return"Please select a network first.";if((b=this.validateschedules())&&0>$.inArray("schedule",a))return b},validateschedules:function(){var a;if(a=this.validateschedule(this.get("schedule")))return a;
$.each(this.get("variations"),function(b,c){return(a=this.validateschedule(c.schedule))?!1:!0}.bind(this));return a},validateschedule:function(a){if(!a)return!1;var b=a.date||null;a=a.repeat?a.repeat.until:null;return b&&b<moment().unix()?"One or more streams are scheduled into the past.":b&&a&&a<b?"One or more streams have the repeat date happening before the scheduled date.":!b&&a&&a<moment().unix()?"One or more streams have the repeat date set to the past.":!1},hascontent:function(){var a;if(this.get("attachments")&&
this.get("attachments").length)return this.get("attachments").length;if(this.get("body").plaintext)return this.get("body").plaintext.length;if(this.get("variations")&&this.get("variations").length)return $.each(this.get("variations"),function(b,c){if(c.attachments&&c.attachments.length)return a=c.attachments.length,!1;if(c.body&&c.body.plaintext)return a=c.body.plaintext.length,!1}.bind(this)),a},validatecontent:function(){var a=1,b;this.get("streams")&&this.get("streams").length&&$.each(this.get("streams"),
function(c,e){var f=Cloudwalkers.Session.getStream(e).get("network"),f=f.limitations["max-length"]?f.limitations["max-length"].limit:null;if(!f)return!0;if(b=this.getvariation(e)){if(b.body&&b.body.plaintext)return a=f-b.body.plaintext.length,0>a?!1:!0}else if(this.get("body")&&this.get("body").plaintext&&(a=f-this.get("body").plaintext.length,0>a))return!1}.bind(this));return 0<a},sanitizepost:function(){this.attributes.body.html&&delete this.attributes.body.html;this.attributes.variations&&this.attributes.variations.forEach(function(a,
b){a.body&&(a.body.plaintext?a.body.html&&delete a.body.html:delete a.body);0>this.attributes.streams.indexOf(a.stream)&&this.attributes.variations.splice(b,1)}.bind(this))},cloneSanitized:function(){var a=this.clone();a.attributes.date&&delete a.attributes.date;a.attributes.from&&delete a.attributes.from;a.attributes.stream&&delete a.attributes.stream;a.attributes.streams=[];a.id&&(delete a.id,delete a.attributes.id);return a},checkloaded:function(a){a.objectType&&setTimeout(function(a){a.trigger("loaded")},
1,this)},filterData:function(a){var b={};$.each("id objectType actiontokens subject body date engagement from read stream streams attachments parent statistics canHaveChildren children_count schedule variations".split(" "),function(c,f){void 0!==a[f]&&(b[f]=a[f])});var c=Cloudwalkers.Session.getStream(a.stream);c&&(b.icon=c.get("network").icon,b.networktoken=c.get("network").token,b.networkdescription=c.get("name"));a.attachments?(a.attachments.length&&(b.media=a.attachments[a.attachments.length-
1],b.media="image"==b.media.type?"picture":b.media.type),b.attached={},$.each(a.attachments,function(a,c){b.attached[c.type]=c})):b.media="reorder";a.engagement&&(b.trending=1E3>a.engagement?a.engagement:"+999");b.schedule&&(b.scheduledate=moment(b.schedule.date).format("DD MMM YYYY HH:mm"));a.body&&(b.body.intro=a.body.plaintext?a.body.plaintext.substr(0,72):"...");a.date&&(b.fulldate=moment(a.date).format("DD MMM YYYY HH:mm"),b.dateonly=moment(a.date).format("DD MMM YYYY"),b.time=moment(a.date).format("HH:mm"));
return b},generateintro:function(){this.get("body")&&!this.get("body").intro&&(this.attributes.body.intro=this.get("body").plaintext.substr(0,72))},filterActions:function(){return this.get("actiontokens")?this.actions.rendertokens():[]},filterCalReadable:function(){var a=this.get("objectType"),b=a&&"reorder"!=this.get("media");this.calNode||(this.calNode={id:this.id});this.get("schedule")?this.calNode.start=a?$.fullCalendar.moment(this.get("scheduledate")):$.fullCalendar.moment():this.calNode.start=
a?$.fullCalendar.moment(this.get("date")):$.fullCalendar.moment();this.calNode.title=a?(this.get("title")?this.get("title"):this.get("body").plaintext).substring(0,b?12:16):"...";this.calNode.className=a?this.get("networktoken")+"-color":"hidden";this.calNode.networkdescription=a?this.get("networkdescription"):null;this.calNode.intro=a?this.get("body").intro:null;this.calNode.icon=a?this.get("icon"):null;this.calNode.media=b?this.get("media"):null;a&&72<=this.calNode.intro.length&&(this.calNode.intro+=
"...");return this},attach:function(a,b,c){c=this.get("attachments")||[];a=b&&c[b]?$.extend(c[b],a):c.push(a);this.set({attachments:c});return a},unattach:function(a){(this.get("attachments")||[]).splice(a,1)},addcampaign:function(){},setvariation:function(a,b,c){var e=this.get("variations")||[],f=e.filter(function(b){if(b.stream==a)return b});if(0==f.length){f={stream:a};if("image"==b||"link"==b){var g=[c];f.attachments=g}else b&&(f[b]=c);e.push(f)}else f=f[0],"image"==b||"link"==b?(g=f.attachments||
...
this.get("variations")?this.get("variations").filter(function(b){return a&&b.stream==a.id}):[],f=a?e.length?e[0]:{stream:a.id}:this.attributes;void 0!==c&&(f[b]=c,a&&!e.length&&this.get("variations").push(f));return f[b]},removevariation:function(a){var b=this.get("variations");b&&$.each(b,function(c,e){if(e.stream==a)return b.splice(c,1),!1})},removevarimg:function(a,b){var c=this.getvariation(a),c=c?c.attachments:[];if(_.isNumber(b))this.addexclude(a,b);else for(n in c)"image"==c[n].type&&c[n].name==
b&&c.splice(n,1)},addexclude:function(a,b){var c=this.getvariation(a)||this.setvariation(a);c.excludes?c.excludes.attachments.push(b):c.excludes={attachments:[b]}},checkexclude:function(a,b){var c=this.getvariation(a);if(c)c=c.excludes;else return!1;if(c)for(n in c.attachments)if(c.attachments[n]==b)return!0;return!1},location:function(){return"#"},afterChange:function(){this.addInternalActions();this.get("parent")&&this.get("parentmodel").set(this.get("parent"))},getActionIcon:function(a){return"internal-share"==
...
b[i],p[i]>e&&(e=p[i]),p[i]>f&&(f=p[i])});g=0<p.length?p.indexOf(Math.max.apply(Math,_.values(p))):-1;c.push({day:a.shift(),value:f,time:g});f=0});c.maxvalue=e;return c}});Cloudwalkers.Collections.Triggers=Backbone.Collection.extend({model:Cloudwalkers.Models.Trigger,typestring:"triggers",initialize:function(){},parse:function(a){return a.account.triggers},url:function(){var a=[CONFIG_BASE_URL+"json"];this.parent?a.push(this.parent.typestring,this.parent.id,this.typestring):this.typestring&&a.push(this.typestring);return a.join("/")}});Backbone.View=Backbone.View.extend({loadListeners:function(a,b,c){var e=b.length,f="listenTo";c&&(f="listenToOnce");for(i in b)if(_.isArray(b[i]))for(n in b[i])this[f](a,b[i][n],this.loadRender.bind(this,Number(i)+1,e));else this[f](a,b[i],this.loadRender.bind(this,Number(i)+1,e));this.listenTo(a,"ready:empty",this.emptylist.bind(this));this.on("rendered",this.addLoader)},addLoader:function(){this.container=this.$loadercontainer?this.$loadercontainer:this.$container;this.loader=$(Templates.progressbar).appendTo(this.container)},
...
this.compose({model:a.clone(),clone:!1,redirect:!1}):this.compose({model:a.clone(),clone:!0,actionparameters:c,redirect:!1,type:"post"})},shareMessage:function(a){this.compose({model:a.clone(),clone:!0,redirect:!1})},confirm:function(a,b,c){var e={};e.message=a;e.options=[{token:"confirm",label:this.translateString("yes"),description:"Confirm your action"}];e.translate_close=this.translateString("close");a=Mustache.render(Templates.uiconfirm,e);a=$(a);var f=a.modal();a.find("[data-response=confirm]").click(function(){b();
...
"DEVELOPMENT"==a.platform.name)this.development=!0,$("#header").html(this.renderHeader().header)},renderHeader:function(){var a={dev:this.development};a.user=Cloudwalkers.Session.user.attributes;a.accounts=[];a.level=Cloudwalkers.Session.getUser().level;this.mustacheTranslateRenderHeader(a);Cloudwalkers.Session.user.accounts.each(function(b){a.accounts.push({name:b.get("name"),id:b.id,active:b.id==Cloudwalkers.Session.get("currentAccount")})});Cloudwalkers.Session.censuretemplate(a);this.header=Mustache.render(Templates.header,
a);return this},render:function(){var a=Cloudwalkers.Session.getAccount(),b={reports:[]};b.level=Cloudwalkers.Session.getUser().level;this.mustacheTranslateRender(b);Cloudwalkers.Session.isAuthorized("MESSAGE_READ_THIRDPARTY")&&(b.news=a.channels.findWhere({type:"news"}),b.news&&(b.news=a.channels.findWhere({type:"news"}).id));if(Cloudwalkers.Session.isAuthorized("MESSAGE_READ_MONITORING")){var c=a.channels.findWhere({type:"monitoring"});c&&(b.monitoring={channelid:c.id,first:c.channels.models[0],
channels:c.channels.models,name:c.get("name")})}Cloudwalkers.Session.isAuthorized("MESSAGE_READ_SCHEDULE")&&(b.scheduled={channelid:Cloudwalkers.Session.getChannel("internal").id},b.scheduled.streams=a.streams.where({outgoing:1}));Cloudwalkers.Session.isAuthorized("_CW_INBOX_VIEW")&&(b.inbox=!0);Cloudwalkers.Session.isAuthorized("MESSAGE_READ_COMPANY")&&(c=a.channels.findWhere({type:"profiles"}),b.profiles={channelid:c.id,streams:c.streams.models,name:c.get("name")});Cloudwalkers.Session.isAuthorized("STATISTICS_VIEW")&&
(b.reports=a.streams.where({statistics:1}).map(function(a){return a.attributes}));Cloudwalkers.Session.censuretemplate(b);this.$el.html(Mustache.render(Templates.navigation,b));this.handleSidebarMenu();return this},handleSidebarMenu:function(){var a=Backbone.history.fragment;if(!a)return null;this.setActive(a)},compose:function(){Cloudwalkers.RootView.compose()},writenote:function(){var a=Cloudwalkers.Session.getAccount();Cloudwalkers.RootView.writeNote(a)},setActive:function(a){$("#sidebar .active").removeClass("active");
$('a[href="#'+a+'"]').parents("#sidebar .page-sidebar-menu *").addClass("active")},setNotifications:function(a){this.$el.find(".popup-frame ul").html("");for(var b=0;b<a.length;b++)this.addNotification(a[b])},addNotification:function(a){this.$el.find(".popup-frame ul").append('<li><div class="text account"><p>'+a.message+'</p><div class="row"><span class="time"></span></div></div></li>')},toggleNotifications:function(){this.$el.find(".notification-popup").toggle()},mapViews:function(){var a={};for(n in this.views)if(a[this.views[n].name]=
{streams:[]},this.views[n].children)for(i in this.views[n].children)a[this.views[n].children[i].name]={streams:[]};return a},translateString:function(a){return Cloudwalkers.Session.polyglot.t(a)},mustacheTranslateRenderHeader:function(a){this.original=["write_note","clean","support","profile_settings","log_out"];this.translated=[];for(k in this.original)this.translated[k]=this.translateString(this.original[k]),a["translate_"+this.original[k]]=this.translated[k]},mustacheTranslateRender:function(a){this.original=
"compose dashboard message_board compose_message drafts scheduled inbox messages notifications post_message calendar co-workers_wall company_accounts media trending_posts accounts_we_follow keyword_monitoring manage_accounts manage_keywords reports settings manage_users social_connections account_settings profile_settings manage_user_groups notes".split(" ");this.translated=[];for(k in this.original)this.translated[k]=this.translateString(this.original[k]),a["translate_"+this.original[k]]=this.translated[k]}});Cloudwalkers.Views.Compose=Backbone.View.extend({id:"compose",className:"modal hide",type:"post",network:"default",actionstreams:[],actionview:!1,minutestep:5,maxfilesize:3E6,besttimes:{},titles:{post:"Write Post",edit:"Edit Post",share:"Share message",comment:"Write Comment",reply:"Write Reply",dm:"Write Message",retweet:"Retweet",like:"Like",favourite:"Favourite",plusone:"Plus one","default":"Compose"},translated_titles:{},limitations:{},options:{"false":["editor","images","campaign","schedule",
...
parserepeatdate:function(a){a=$(a);if(!a.val())return null;this.parsemoment(a)},updateschedule:function(){var a;(a=this.draft.original(this.activestream,"schedule"))||(a=this.draft.original(null,"schedule"));this.toggleschedentry(".schedule-group [data-set]",!1).toggleschedentry("[data-set=now], [data-set=onlyonce]",!0);$("#delay-date, #delay-time, #repeat-interval, #repeat-amount, #repeat-until").val("").attr("disabled",!1);$("#repeat-interval, #repeat-amount").val(0);$("[data-set=in] .btn-white").addClass("inactive");
$("#delay-select").val(600);$("#every-select").val(168);$("#every-select-weekday").val(0).attr("disabled",!1);if(a&&a.date&&a.settings&&a.settings.delayselect)this.toggleschedentry("[data-set=now]").toggleschedentry("[data-set=in]",!0),$("#delay-select").val(a.settings.delayselect);else if(a&&a.date&&(this.toggleschedentry("[data-set=now]").toggleschedentry("[data-set=on]",!0),$(this.datepicker.get(0)).datepicker("update",moment.unix(a.date).format("DD/MM/YYYY")),this.timepicker.timepicker("setTime",
moment.unix(a.date).format("HH:mm")),a.besttimetopost)){var b=this.$el.find("[data-set=on] .btn-white");b.hasClass("inactive")&&b.toggleClass("inactive");$("#delay-time").attr("disabled",!0)}a&&a.repeat&&(a.repeat.interval&&(this.toggleschedentry("[data-set=onlyonce]").toggleschedentry("[data-set=every]",!0),[720,168,24,1].some(function(b){var e=a.repeat.interval/b/3600;if(Math.round(e)==e)return $("#repeat-interval").val(e),$("#every-select").val(b),!0})),a.repeat.weekdays&&a.repeat.weekdays.length&&
$("#every-select-weekday").val(a.repeat.weekdays[0]),a.repeat.amount&&(this.toggleschedentry("[data-set=onlyonce]").toggleschedentry("[data-set=repeat]",!0),$("#repeat-amount").val(a.repeat.amount)),a.repeat.until&&(this.toggleschedentry("[data-set=now]").toggleschedentry("[data-set=until]",!0),$(this.datepicker.get(1)).datepicker("update",moment.unix(a.repeat.until).format("DD/MM/YYYY"))))},monitorschedule:function(a,b){var c=b||$(a.currentTarget),c=(c.data("set")?c:c.parents("[data-set]").eq(0)).data("set"),
...
!1),$("[data-set=in] .btn-white").addClass("inactive")):"on"==c?(this.toggleschedentry("[data-set=now], [data-set=in]").toggleschedentry("[data-set=on]",!0),$("[data-set=in] select").val(600),this.parsescheduledate("#delay-date","#delay-time"),e.settings&&e.settings.delayselect&&delete e.settings.delayselect):"onlyonce"==c?(this.toggleschedentry("[data-set=onlyonce]",!0).toggleschedentry("[data-set=repeat], [data-set=until], [data-set=every]",!1),$("#repeat-interval, #repeat-amount").val(0),$("#every-select").val(600),
...
!1,a.repeat.until=b.filter("#repeat-until").val()?moment($("#repeat-until").val(),["DD-MM-YYYY","DD-MM-YY","DD/MM/YYYY"]).unix():!1);return a},summarizeschedule:function(){this.translate_best_time_to_post=this.translateString("best_time_to_post");var a=this.parsescheduled(),b=this.$el.find("[data-collapsable=schedule] .summary").empty();if(a&&a.date){var c=a.besttimetopost?this.translate_best_time_to_post:moment.unix(a.date).format("HH:mm");b.html("<span><i class='icon-time'></i> "+moment.unix(a.date).format("dddd, D MMMM YYYY")+
...
(f=a.repeat.amount,e=c.clone().add("seconds",f*a.repeat.interval));if(f)b.html("<span>"+f+" "+this.translate_times+" "+(e?"<em class='negative'>"+this.translate_until+" "+e.format("dddd, D MMMM YYYY")+"</em>":"")+"</span>");else if(a.repeat.interval){var g,h;[720,168,24,1].some(function(b){g=a.repeat.interval/b/3600;h=b;if(Math.round(g)==g)return!0});b.html("<span>"+this.translate_endless_repeat_every+" "+g+" "+{1:this.translate_hours,24:this.translate_days,168:this.translate_weeks,720:this.translate_months}[h])}return this},
listentocanned:function(a){var b=$(a.currentTarget).val();$(".chosen-single > span").get(0);0!=b&&(a=Cloudwalkers.Session.getCannedResponses().models.filter(function(a){if(a.id==b)return a}),(a=a[0]?a[0].get("body").html:null)&&this.trigger("replace:content",a))},preview:function(){this.$el.addClass("switch-mode");this.preview=new Cloudwalkers.Views.Preview({model:this.draft.clone(),previewtype:"default",streamid:this.activestream.id});this.$el.find(".switch-container").append(this.preview.render().el)},
...
this.initializenote();(Cloudwalkers.Session.isAuthorized("ACCOUNT_TAGS_VIEW")||Cloudwalkers.Session.isAuthorized("ACCOUNT_TAGS_MANAGE"))&&this.loadtagui();this.begintouch();return this},fill:function(a){this.refreshview&&($.each(this.entries,function(a,b){b.remove()}),this.entries=[]);a.length?this.$el.find(".messagelist").removeClass("empty-content"):this.$el.find(".messagelist").addClass("empty-content");var b,c="note"==this.type?"smallentrynote":"smallentry";for(n in a)b=a[n],b.attributes.arrow=
"arrow",b.parent=this.model,b=new Cloudwalkers.Views["note"==this.type?"NoteEntry":"Entry"]({model:b,template:c,checkunread:!0,parameters:{inboxview:!0,parent:this}}),this.entries.push(b),this.listenTo(b,"toggle",this.loadmessage),"note"==this.type&&b.$el.addClass("noteentry"),this.$container.append(b.render().el);this.refreshview=!1},seed:function(a,b){this.collection.models=b.contact.messages;this.collection.length=this.collection.models.length;this.collection.trigger("seed",this.collection.models)},
begintouch:function(a){a||(a="messages");this.type=a;this.loadmylisteners(!0);this.refreshview=!0;"messages"==a?this.getmessages():this.touch(a)},getmessages:function(a){this.model.urlparams=["messages"];this.model.parameters=a||!1;this.collection.url=this.model.url();this.collection.parenttype="contact";this.collection.contactinfo=this.contactinfo;this.collection.parse=this.parse;this.collection.fetch({success:this.seed.bind(this)})},parse:function(a){this.parenttype&&(a=a[this.parenttype]);if(a[this.typestring]){for(n in a[this.typestring])a[this.typestring][n]=
...
a?this.togglenoteaction("note-content"):(this.$el.find(".message-body").removeClass("note-content").html(this.model.get("text")),this.$el.find(".toggle-note-actions").toggle())},saved:function(){setTimeout(function(){this.canceledit();this.loadmylisteners()}.bind(this),200)},togglenoteaction:function(a){var b="note-list"==a?"note-content":"note-list",c=this.$el.find(".message-notes"),e=this.$el.find("."+a),f=this.$el.find("[data-action="+a+"]"),g=this.$el.find("[data-action="+b+"]"),b=this.$el.find("."+
b);c.is(":visible")||f.hasClass("inactive")?c.is(":visible")&&!f.hasClass("inactive")?(b.slideUp("fast"),g.removeClass("inactive"),e.slideDown(),f.addClass("inactive")):c.is(":visible")&&f.hasClass("inactive")&&(this.$el.find(".message-notes").slideUp(),f.removeClass("inactive"),b.slideUp(),e.slideUp()):(this.$el.find(".message-notes").slideDown(),e.slideDown(),f.addClass("inactive"));"note-list"!=a||this.loadednotes||this.fetchnotes()},toggleaction:function(a,b){var c=this.$el.find('[data-action="'+
a+'"]'),e=c.clone().attr("data-action",b.token);c.is("a")?e.html("<i class='icon-"+b.icon+"'></i> "+b.name):e.find("i").attr("class","").addClass("icon-"+b.icon);c.before(e).remove()},toggle:function(){this.trigger("toggle",this)},checkUnread:function(){this.model.get("read")?this.$el.removeClass("unread"):this.$el.addClass("unread")},loadNotifications:function(){if(this.$el.find(".timeline-comments li").size())return this.$el.find(".timeline-comments li").remove();this.listenTo(this.model.notifications,
"seed",this.fillNotifications);this.model.notifications.touch(this.model,{records:50,markasread:!0})},fillNotifications:function(a){$.each(this.notifications,function(a,b){b.remove()});this.notifications=[];a.models&&(a=a.models);var b=this.$el.find(".timeline-comments").eq(0).html("");for(n in a){var c=new Cloudwalkers.Views.Notification({model:a[n],template:"timelinecomment"});this.notifications.push(c);b.append(c.render().el)}},loadYoutube:function(){var a=this.$el.find(".timeline-video").eq(0),
b=a.data("youtube");a.attr("data-youtube","").removeClass("inactive");a.html(Mustache.render(Templates.youtube,{url:b}))},loadnoteui:function(){var a=new Cloudwalkers.Views.ComposeNote({model:this.model,persistent:!0});this.composenote=a;this.listenTo(a.note,"sync",this.noteadded);this.listenTo(a,"edit:cancel",this.canceledit.bind(this,!0));this.$el.find(".note-content").append(a.render().el)},fetchnotes:function(){var a=new Cloudwalkers.Collections.Notes;a.parentmodel=this.model;a.parenttype="message";
this.listenTo(a,"seed",this.fillnotes);a.touch(this.model);this.loadednotes=!0},fillnotes:function(a){a.length?this.$el.find(".note-list").empty():this.$el.find(".note-list li").html("No notes found");for(n in a)this.addnote(a[n])},addnote:function(a){a={model:a,template:"messagenote"};this.newnote&&(a.isnew=!0);a=new Cloudwalkers.Views.Widgets.NoteEntry(a);this.$el.find(".note-list").append(a.render().el);this.newnote=!1},noteadded:function(a){this.togglenoteaction("note-list");this.newnote=!0;this.fetchnotes();
this.composenote.remove();this.loadnoteui()},loadtagui:function(){this.fetchtags()},fetchtags:function(){var a=new Cloudwalkers.Collections.Tags;a.parentmodel=this.model;a.parenttype="message";this.listenTo(a,"seed",this.rendertag);a.touch(this.model);this.loadedtags=!0},rendertag:function(a){a.length?this.$el.find(".tag-list").empty():this.$el.find(".tag-list").html(this.translateString("no_tags_found"));this.$el.find(".tag-list").empty();for(n in a)this.addtag(a[n])},submittag:function(a){this.tag=
new Cloudwalkers.Models.Tag;this.model&&(this.tag.parent=this.model);this.tag.save({name:a},{success:this.addtag.bind(this)})},addtag:function(a){a=new Cloudwalkers.Views.Widgets.TagEntry({model:a,parent:this.model,template:"messagetag"});this.$el.find(".tag-list").append(a.render().el)},entertag:function(a){if(13===a.which){var b=$(a.target).val();b&&(this.submittag(b),$(a.target).val(""))}},time:function(){var a=new Date,b=new Date(this.$el.find("[data-date]").attr("data-date")),a=Math.round(0.0010*
(a.getTime()-b.getTime())),a=60>a?"now":3600>a?Math.round(a/60)+"m":86400>a?Math.round(a/3600)+"h":2592E3>a?Math.round(a/86400)+"d":Math.round(a/2592E3)+"mo";this.$el.find("[data-date]").html(a);this.tm=setTimeout(this.time.bind(this),6E4)},destroy:function(){window.clearTimeout(this.tm)},translateString:function(a){return Cloudwalkers.Session.polyglot.t(a)},mustacheTranslateRender:function(a){this.original=["comments"];this.translated=[];for(k in this.original)this.translated[k]=this.translateString(this.original[k]),
a["translate_"+this.original[k]]=this.translated[k]}});Cloudwalkers.Views.NoteEntry=Cloudwalkers.Views.Entry.extend({className:"note",events:{remove:"destroy","click [data-notifications]":"loadNotifications","click [data-youtube]":"loadYoutube","click *[data-action]":"action",click:"toggle"},initialize:function(a){this.parameters={};a&&$.extend(this,a);this.listenTo(this.model,"change",this.render);this.listenTo(this.model,"action:toggle",this.toggleaction);this.listenTo(this.model,"destroy",this.remove)},render:function(){$.extend(this.parameters,this.model.attributes);
this.model.loaded()&&(this.model.loaded("model")&&(this.model.parent?this.parameters.parent=this.model.parent.attributes:(this.model.parent=this.model.attachParent(this.model.get("model").objectType,this.model.get("model").id),this.model.parent.loaded()||this.listenTo(this.model.parent,"sync",this.render))),"full"==this.type&&(this.parameters.actions=this.model.filterActions()));Cloudwalkers.Session.censuretemplate(this.parameters);for(n in this.parameters.actions)this.parameters.actions[n].name_translated=
...
"sync",this.hideloading);this.listenTo(this.collection,"ready",this.showmore);this.listenTo(this.model.contacts,"add",this.comparesuggestions);this.listenTo(this.collection,"ready:empty",this.isempty);this.listenTo(this.collection,"request",this.unsetempty);this.listenTo(Cloudwalkers.RootView,"added:note",function(){this.collection.touch(this.model,this.filterparameters())}.bind(this));this.loadListeners(this.collection,["request","sync",["ready","loaded"]],!0)},toggleall:function(){this.filternetworks(null,
...
a));this.filters.streams.length&&(this.$el.find("[data-streams], [data-networks], .toggleall").toggleClass("inactive active"),this.$el.find(this.filters.streams.map(function(a){return'[data-networks~="'+a+'"],[data-streams="'+a+'"]'}).join(",")).toggleClass("inactive active"));this.$container=this.$el.find("ul.list");this.collection.touch(this.model,this.filterparameters());this.listenTo(this.collection,"ready",this.afterrender);return this},fill:function(a){this.incremental?this.incremental=!1:($.each(this.entries,
function(a,b){b.remove()}),this.entries=[]);for(n in a){var b=new Cloudwalkers.Views.NoteEntry({model:a[n],template:this.entrytemplate,parameters:{inboxview:!0}});this.entries.push(b);this.listenTo(b,"toggle",this.toggle);this.$container.append(b.render().el)}},afterrender:function(){this.entries.length?setTimeout(this.toggle.bind(this,this.entries[0]),1):this.hidemore()},toggle:function(a){var b={model:a.model};this.inboxnote&&this.inboxnote.remove();this.inboxnote=new Cloudwalkers.Views.Widgets.InboxNote(b);
$(".inbox-container").html(this.inboxnote.render().el);this.rendercontext();this.inboxnote.showrelated();this.$el.find(".list .active").removeClass("active");a.$el.addClass("active")},togglefilter:function(a){a=$(a.currentTarget);var b=a.data("toggle"),c=a.hasClass("selected");this.$el.find("[data-toggle].selected").removeClass("selected");this.$el.find("[id^=filter_]").addClass("hidden");c||(a.addClass("selected"),this.$el.find("#filter_"+b).removeClass("hidden"))},rendercontext:function(){var a=
this.inboxnote.getcontext(),b;if("message"==a.objectType){var c=$('<div class="message social-box-colors"></div>');a.display=!0;b=Mustache.render(Templates.inboxmessage,a);b=c.append(b)}else"contact"==a.objectType&&(b=Mustache.render(Templates.singlecontact,a));$(".inbox-container").prepend(b)},comparesuggestions:function(a){var b=this.$el.find("#filter_contacts input").val();if(b)b=b.toLowerCase();else return this.hidesuggestions();var c=this.model.contacts.filter(this.comparenamefilter.bind(this,
b));5>c.length&&(!a.cid&&2<b.length)&&this.requestcontacts(b);if(c.length)this.showsuggestions(c.slice(0,10));else return this.hidesuggestions()},comparenamefilter:function(a,b){return 0<=b.get("displayname").toLowerCase().indexOf(a)||b.get("name")&&0<=b.get("name").toLowerCase().indexOf(a)},showsuggestions:function(a){this.$el.find("#filter_contacts label").removeClass("hidden");this.$el.find("ul.contacts-suggestions").empty();for(n in a)this.$el.find("ul.contacts-suggestions").append(Mustache.render(Templates.contactsuggestionentry,
a[n].attributes))},hidesuggestions:function(){this.$el.find("#filter_contacts label").addClass("hidden");this.$el.find("ul.contacts-suggestions").empty()},requestcontacts:function(a){a!=this.filters.contacts.string&&(this.model.contacts.processing?this.filters.contacts.buffered=a:(this.$el.find(".loading-contacts").removeClass("hidden"),this.filters.contacts.string=a,this.model.contacts.fetch({remove:!1,parameters:{q:a,channels:this.model.id},success:this.loadedcontacts.bind(this)})))},loadedcontacts:function(){this.$el.find(".loading-contacts").addClass("hidden");
this.filters.contacts.buffered&&(this.requestcontacts(this.filters.contacts.buffered),this.filters.contacts.buffered=!1)},filtercontacts:function(a){a=$(a.currentTarget);if(a.data("contact"))a=Cloudwalkers.Session.getContact(a.data("contact")),0>this.filters.contacts.list.indexOf(a.id)&&(this.filters.contacts.list.push(a.id),this.$el.find("ul.contacts-placeholder").append(Mustache.render(Templates.contactselectedentry,a.attributes)));else{var b=a.data("close-contact");this.filters.contacts.list=this.filters.contacts.list.filter(function(a){return a!=
b});this.$el.find("[data-close-contact="+b+"]").parent().remove()}this.collection.touch(this.model,this.filterparameters());return this},filternetworks:function(a,b){this.loadmylisteners(!0);b||(b=this.button&&this.button.data("networks")==$(a.currentTarget).data("networks"));this.togglestreams(b);b||(this.button=$(a.currentTarget).addClass("active").removeClass("inactive"));var c=b?null:String(this.button.data("networks")).split(" ");b&&(this.button=!1);c?($(c.map(function(a){return'[data-streams="'+
a+'"]'}).join(",")).removeClass("inactive").addClass("active"),this.filters.streams=c):this.filters.streams=[];this.collection.touch(this.model,this.filterparameters());return this},filterstreams:function(a,b){this.loadmylisteners(!0);b||(b=this.button&&this.button.data("streams")==$(a.currentTarget).data("streams"));this.togglestreams(b);b||(this.button=$(a.currentTarget).addClass("active").removeClass("inactive"));var c=b?null:Number(this.button.data("streams"));b&&(this.button=!1);c?($('[data-networks~="'+
...
this.model.get("firstname")+translate_sure,function(){c.remove();var a="account/"+Cloudwalkers.Session.getAccount().get("id")+"/users/"+b.model.get("id");Cloudwalkers.Net.remove(a,{},function(){Cloudwalkers.RootView.growl(translate_manage_users,translate_thats_an_ex_user)})})},translateString:function(a){return Cloudwalkers.Session.polyglot.t(a)}});Cloudwalkers.Views.Settings.UserDetails=Backbone.View.extend({events:{"submit form.edit-managed-user":"submit"},initialize:function(a){a&&$.extend(this,a);this.listenTo(this.model,"request",this.disablesave);this.listenTo(this.model,"sync",this.enablesave);this.role=this.model.get("rolegroup");this.roles=Cloudwalkers.Session.getAccount().get("roles");if(!this.roles||_.isUndefined(this.role))return Cloudwalkers.RootView.resync("#"+Backbone.history.fragment)},render:function(){var a={},b=this.roles;
