...
c:c.parents("[data-set]").eq(0)).data("set");(schedule=this.draft.original(this.activestream,"schedule"))||(schedule={repeat:{}});schedule.now&&delete schedule.now;"now"==c?(this.toggleschedentry("[data-set=in], [data-set=on]").toggleschedentry("[data-set=now]",!0),$("[data-set=on] input").val("").attr("disabled",!1),$("[data-set=in] select").val(600),$("[data-set=in] .btn-white").addClass("inactive"),schedule={repeat:schedule.repeat,now:!0}):"in"==c?(this.toggleschedentry("[data-set=now], [data-set=on]").toggleschedentry("[data-set=in]",
