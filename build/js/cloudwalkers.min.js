...
chart:"PieChart",title:"By gender"},span:3,networks:["facebook"]},{widget:"Chart",data:{filterfunc:"follow",chart:"PieChart",title:"By Type"},span:3,networks:["twitter","linkedin","youtube"]},{widget:"TitleSeparator",data:{title:"Network info"}},{widget:"Info",data:{title:"New impressions",filterfunc:"page-views-network"},span:3},{widget:"Info",data:{title:"New shares",filterfunc:"shares"},span:3},{widget:"Info",data:{title:"New posts",filterfunc:"posts"},span:3},{widget:"Info",data:{title:"New direct messages",
filterfunc:"dms"},span:3},{widget:"TitleSeparator",data:{title:"Messages info"}},{widget:"TrendingMessage",data:{title:"Top rated comment"},span:12},{widget:"BestTimeToPost",data:{filterfunc:"besttime",chart:"LineChart",title:"Best Time to Post"},span:4},{widget:"Chart",data:{filterfunc:"message-evolution-network",chart:"LineChart",title:"Messages Evolution"},span:4},{widget:"HeatCalendar",data:{filterfunc:"activity",title:"Activity Calendar"},span:4},{widget:"TitleSeparator",data:{title:"Geo Graphics"},
networks:["facebook"]},{widget:"Chart",data:{filterfunc:"geo",type:"dots",chart:"GeoChart",title:"Countries",connect:!0},networks:["facebook"],span:8},{widget:"CompoundChart",span:4,data:{template:"2row",chartdata:[{widget:"Chart",data:{filterfunc:"regional",chart:"PieChart",title:"Countries"},connect:"regional"},{widget:"Chart",data:{filterfunc:"cities",chart:"PieChart",title:"Cities"}}]},networks:["facebook"]}],streamdata:function(a){var b=Cloudwalkers.Session.getStream(Number(this.streamid)).get("network").token,
c={};if(a.networks&&0>a.networks.indexOf(b))return!1;c.network=this.streamid;return _.extend(a.data,c)}});Cloudwalkers.Views.Settings=Cloudwalkers.Views.Pageview.extend({title:"Settings",tabs:[],initialize:function(){this.endpoint=this.options.endpoint;this.level=Cloudwalkers.Session.user.level},setAction:function(a){this.action=a},render:function(){var a={};this.tabs=[];this.mustacheTranslateRender(a);Cloudwalkers.Session.isAuthorized("USER_INVITE")&&this.tabs.push({url:"#settings/users",name:a.translate_manage_users});Cloudwalkers.Session.isAuthorized("SERVICE_CONNECT")&&this.tabs.push({url:"#settings/services",
