...
this.options.channel.url(),this.collection.fetch({remove:!1}))},updatesettings:function(a){if("streams"!=this.options.source&&"outgoing"!=this.options.source)return null;a=this.collection.get($(a.currentTarget).data("stream"));var b=a.get("childtypes")[0]+"s";"outgoing"==this.options.source&&(b="scheduled");var c=Cloudwalkers.Session.viewsettings(b);c.streams=[a.id];Cloudwalkers.Session.viewsettings(b,c)},negotiateFunctionalities:function(){this.$el.find(".scroller").length&&this.addScroll();this.options.counter&&
