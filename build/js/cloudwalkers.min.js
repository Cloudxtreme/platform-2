...
deleteMessage:function(){var a=this;this.repeat().repeat?Cloudwalkers.RootView.dialog("Are you sure you want to remove this message?",[{label:"Skip once",description:"Message will be skipped once",token:"skip"},{label:"Delete forever",description:"Message will never be repeated",token:"remove"}],function(b){b="post/?"+b.token+"="+a.get("id");jQuery.ajax({dataType:"json",type:"get",url:b,success:function(b){a.trigger("destroy",{wait:!0})}})}):Cloudwalkers.RootView.confirm("Are you sure you want to remove this message?",
function(){a.destroy({success:function(){a.trigger("destroy",a,a.collection)}})})},humandate:function(a){a=new Date(a?a:this.get("date"));return Cloudwalkers.Utils.longdate(a)},shortdate:function(){var a=this.date();return Cloudwalkers.Utils.shortdate(a)},time:function(){var a=this.date();return Cloudwalkers.Utils.time(a)},date:function(){return new Date(this.get("date"))},getAction:function(a){for(var b=this.get("actions"),c=0;c<b.length;c++)if(b[c].token==a)return b[c];return null},act:function(a,
