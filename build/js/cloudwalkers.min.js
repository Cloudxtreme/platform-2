...
$("[data-set=in] .btn-white").addClass("inactive");$("#delay-select").val(600);$("#every-select").val(168);$("#every-select-weekday").val(0).attr("disabled",!1);a&&a.date&&a.settings&&a.settings.delayselect?(this.toggleschedentry("[data-set=now]").toggleschedentry("[data-set=in]",!0),$("#delay-select").val(a.settings.delayselect)):a&&a.date&&(this.toggleschedentry("[data-set=now]").toggleschedentry("[data-set=on]",!0),$(this.datepicker.get(0)).datepicker("update",moment.unix(a.date).format("DD/MM/YYYY")),
this.timepicker.timepicker("setTime",moment.unix(a.date).format("HH:mm")));a&&a.repeat&&(a.repeat.interval&&(this.toggleschedentry("[data-set=onlyonce]").toggleschedentry("[data-set=every]",!0),[720,168,24,1].some(function(b){var c=a.repeat.interval/b/3600;if(Math.round(c)==c)return $("#repeat-interval").val(c),$("#every-select").val(b),!0})),a.repeat.weekdays&&a.repeat.weekdays.length&&$("#every-select-weekday").val(a.repeat.weekdays[0]),a.repeat.amount&&(this.toggleschedentry("[data-set=onlyonce]").toggleschedentry("[data-set=repeat]",
