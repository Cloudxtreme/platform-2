...
this.translateString("the_user_clearance_is_updated"));this.model.trigger("change:clearance")},error:function(a,b){var c=b.responseJSON?b.responseJSON.error.message:this.translateString("something_went_wrong");Cloudwalkers.RootView.alert(c)},disablesave:function(){this.$el.find(".edit-managed-user .btn").attr("disabled",!0)},enablesave:function(){this.$el.find(".edit-managed-user .btn").attr("disabled",!1)},translateString:function(a){return Cloudwalkers.Session.polyglot.t(a)},mustacheTranslateRender:function(a){this.original=
["clearance_level","save"];this.translated=[];for(k in this.original)this.translated[k]=this.translateString(this.original[k]),a["translate_"+this.original[k]]=this.translated[k]}});Cloudwalkers.Views.Settings.Profile=Backbone.View.extend({events:{"click .add-user":"addUser","submit .edit-user-profile":"editUserProfile","submit .edit-user-password":"editUserPassword","click #add-file":"addfile","change input[type=file]":"listentofile","click #upload-file":"uploadfile","change select":"enablereset","keydown input":"enablereset","click [type=reset]":"disablereset"},"class":"section",collections:[],render:function(){var a=Cloudwalkers.Session.getUser(),b=this,c={user:{firstname:a.get("firstname"),
