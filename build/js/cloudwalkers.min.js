...
type:"string",required:!1,value:""}]},comment:{name:"Comment",icon:"comment",token:"comment",type:"dialog",clone:!0,compound:"comment",valuetag:"comments",tokenview:"comment-list",maxsize:{twitter:140},parameters:[{token:"message",name:"Message",type:"string",required:!1,value:""}]},retweet:{name:"Retweet",icon:"retweet",token:"retweet",type:"options",valuetag:"retweets"},like:{name:"Like",icon:"thumbs-up",token:"like",type:"options",toggle:"unlike",valuetag:"likes"},unlike:{name:"Unlike",icon:"thumbs-down",
token:"unlike",type:"growl",toggle:"like",actiontype:"like"},favorite:{name:"Favorite",icon:"star",token:"favorite",type:"options",toggle:"unfavorite",valuetag:"favourites"},unfavorite:{name:"Unfavorite",icon:"star-empty",token:"unfavorite",type:"growl",toggle:"favorite",actiontype:"favorite"},plusone:{name:"Unfavorite",icon:"google-plus-sign",token:"plusone",type:"options",toggle:"unplusone"},unplusone:{name:"Unfavorite",icon:"google-plus-sign",token:"unplusone",type:"growl",toggle:"plusone",actiontype:"plusone"}},
initialize:function(a,b){b&&$.extend(this,b);this.listenTo(this.parent,"action",this.startaction)},parse:function(a){return a},url:function(){var a=this.parameters?"?"+$.param(this.parameters):"",b=this.parent?this.parent.get("objectType")+"s/"+this.parent.id:"";return Cloudwalkers.Session.api+"/"+b+"/actions"+a},rendertokens:function(a){var b,c=[],e=this.parent.get("stats");a||(a=this.parent.get("actiontokens"));for(n in a)if(token=a[n],b=this.templates[token])e&&(b=this.appendstat(token)),c.push(b);
return c},appendstat:function(a){if(this.templates[a]){var b={},c=this.templates[a].valuetag||null;$.extend(b,this.templates[a]);c&&this.parent.get("stats").hasOwnProperty(c)&&(b.value=this.parent.get("stats")[c]);return b}},startaction:function(a){var b=this.templates[a];this.listenTo(Cloudwalkers.RootView,a.concat(":success"),this.toggleAction);if("confirm"==b.type)this[a](this.parent);else{if("growl"==b.type)return Cloudwalkers.RootView.growl(b.name,this.translateString("the")+" "+b.token+" "+
this.translateString("is_planned_with_success")),b.id=1,b.parent=this.parent,(new Cloudwalkers.Models.Action(b)).destroy();if("note"==b.type)Cloudwalkers.RootView.writeNote(this.parent);else var c="edit"==b.type?{model:this.parent}:{reference:this.parent,action:new Cloudwalkers.Models.Action(b)};Cloudwalkers.RootView.compose(c)}},"delete":function(a){a.deleteMessage()},like:function(){},toggleAction:function(a){var b=this.templates[a];b.toggle&&this.parent.trigger("action:toggle",a,this.templates[b.toggle])},
translateString:function(a){return Cloudwalkers.Session.polyglot.t(a)}});Cloudwalkers.Collections.Reports=Backbone.Collection.extend({model:Cloudwalkers.Models.Report,typestring:"statistics",modelstring:"report",processing:!1,parameters:{},paging:{},cursor:!1,initialize:function(a){a&&$.extend(this,a);Cloudwalkers.Session.user.account&&Cloudwalkers.Session.getReports().listenTo(this,"add",Cloudwalkers.Session.getReports().distantAdd)},distantAdd:function(a){this.get(a.id)||this.add(a)},url:function(){return Cloudwalkers.Session.api+"/streams/"+this.streamid+"/reports?complete=1"},
