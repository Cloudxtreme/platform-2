...
20>a&&b.removeClass().addClass("limit-counter").addClass("color-notice");0>a&&b.removeClass().addClass("limit-counter").addClass("color-warning");b.empty().html(a)},limitwarning:function(){Cloudwalkers.RootView.alert("You have reached the limit number of characters. Exceeding text will not be shown.");this.hasbeenwarned=!0},savepos:function(a){a=a.target.tagName;"I"!=a&&"SHORT"!=a&&(this.pos=this.cursorpos())},cursorpos:function(a,b){var c,e;if(void 0===a)a=0,this.win.getSelection()&&this.win.getSelection().rangeCount&&
(e=this.win.getSelection().getRangeAt(0),c=e.cloneRange(),c.selectNodeContents(this.contenteditable),c.setEnd(e.endContainer,e.endOffset),a=c.toString().length);else{this.getnode(this.$contenteditable[0],a);var f=this.currentnode;if(b)return{node:f.node,offset:f.offset};e=this.document.createRange();c=this.win.getSelection();e.setStart(f.node,f.offset);e.collapse(!0);c.removeAllRanges();c.addRange(e)}return a},togglecontent:function(a,b){if(a)var c=_.isNumber(a.id)?a.id:null,e=_.isObject(a.data)?
