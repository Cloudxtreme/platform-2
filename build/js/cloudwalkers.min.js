...
b=this.draft.get("schedule");b&&b.date&&(b.date=moment(b.date).unix());b&&(b.repeat&&b.repeat.until)&&(b.repeat.until=moment(b.repeat.until).unix());(a=this.draft.get("variations"))&&$.each(a,function(a,b){b.schedule&&(b.schedule.date=moment(b.schedule.date).unix());b.schedule&&(b.schedule.repeat&&b.schedule.repeat.until)&&(b.schedule.repeat.until=moment(b.schedule.repeat.until).unix())});this.state="loaded";this.render();this.$el.find("[data-stream="+this.initstream+"]").click()},render:function(){var a=
...
"addClass"]("icon-circle-blank")[b?"addClass":"removeClass"]("icon-ok-circle");return this},parsemoment:function(a,b){var c=$(a),e;b&&(e=$(b));b&&!e.val()&&this.restarttime();if(!c.val()||b&&!e.val())return null;c=moment(c.val(),"DD-MM-YYYY DD-MM-YY DD/MM/YYYY DD/MM/YY DDMMYYYY YYYYMMDD MM-DD-YYYY MM-DD-YY".split(" "));c=_.clone(c);b&&(e=e.val().split(":"),1<e.length&&c.add("minutes",60*Number(e[0])+Number(e[1])));return c.isValid()?c.unix()<moment().unix()?void 0:c:void 0},updateschedule:function(){var a;
