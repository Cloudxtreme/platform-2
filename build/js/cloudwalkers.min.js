...
getUser:function(a){return a?this.user.account.users.get(a):this.user},getUsers:function(){return this.user.account.users},getContact:function(a){return this.user.account.contacts.get(a)},getContacts:function(){return this.user.account.contacts},getMessage:function(a){return this.user.account.messages.get(a)},getMessages:function(){return this.user.account.messages},getCannedResponse:function(a){return this.user.account.cannedresponses.get(a)},getCannedResponses:function(){return this.user.account.cannedresponses},
...
type:"schedule",source:"streams",size:4,title:"Schedule",icon:"time",open:!0,counter:!0,countString:"scheduled",link:"#scheduled",scrollable:"scrollable",translation:{title:"schedule"}},{widget:"coworkers",type:"drafts",size:4,title:"Co-workers wall",color:"yellow",icon:"edit",open:!0,link:"#coworkers",scrollable:"scrollable",translation:{title:"co-workers_wall"}},{widget:"trending",type:"profiles",size:4,title:"Trending Company Posts",color:"grey",icon:"thumbs-up",open:!0,since:7,sublink:"#trending/",
...
this.keywordFormula().settings.formula&&this.editing.save(this.keywordFormula(),{success:function(){Cloudwalkers.RootView.growl(this.translateString("manage_keywords"),this.translateString("keyword_filter_has_been_updated"))}.bind(this),error:function(){Cloudwalkers.RootView.growl(this.translateString("not_saved"),this.translateString("something_went_wrong"))}.bind(this)});this.$el.find(".managekeyword .icon-cloud-upload").show()},fillKeyword:function(a,b){b.preventDefault();this.render();this.$el.find(".add-keyword, .edit-keyword").toggleClass("inactive");
var c=this.editing=Cloudwalkers.Session.getChannel(a),e=c.get("settings");$('#keyword_manage_category option[value="'+c.get("parent")+'"]').attr("selected","selected");$("#keyword_manage_name").val(c.get("name"));c=e.formula;c=c.replace(/\(/g,",(,");c=c.replace(/\)/g,",),");c=c.replace(/ and /gi,",and,");c=c.replace(/ or /gi,",or,");c=c.split(",");for(n in c)c[n]=c[n].trim();c=$.map(c,function(a){return""!==a?a:null});for(n in c)this.formulaElement(c[n]),this.$el.find("select").chosen({width:"100%"});
$("#keyword_filter #demo_plus").remove();this.addPlus("small");this.$el.find("#keyword_manage_category").trigger("chosen:updated")},addPlus:function(a){"small"==a&&$("#keyword_filter").append('<span id="demo_plus" class="demo_bubble demo_drop demo_hit_me"><span class="demo_hit_me">+</spam><span class="demo_options"><ul><li class="add_and">'+translation.translate_and+'</li><li class="add_or">'+translation.translate_or+"</li></ul></span></span>");"large"==a&&$("#keyword_filter").append('<span id="demo_plus" class="demo_bubble demo_drop demo_hit_me"><span class="demo_hit_me">+</spam><span class="demo_options"><ul><li class="add_message_contains">'+
translation.translate_message_contains+'</li><li class="add_message_no_contains" class="demo_doesntcontain">'+translation.translate_message_doesnt_contain+'</li><li class="add_author_is hidden">'+translation.translate_author_is+'</li><li class="add_author_is_not hidden">'+translation.translate_author_is_not+'</li><li class="add_country_is">'+translation.translate_country_is+'</li><li class="add_country_is_not">'+translation.translate_country_is_not+'</li><li class="add_language_is">'+translation.translate_language_is+
'</li><li class="add_language_is_not">'+translation.translate_language_is_not+'</li><li class="add_group">'+translation.translate_group+"</li></ul></span></span>")},formulaElement:function(a){rand_id=this.getRandomInt(1,999);var b=Cloudwalkers.Session.getAccount().attributes.filteroptions;countries=b.countries;languages=b.languages;b="";for(n in languages)b+='<option value="'+languages[n].token+'">'+languages[n].name+"</option>";var c="";for(n in countries)c+='<option value="'+countries[n].token+
'">'+countries[n].name+"</option>";"or"==a&&$("#keyword_filter").append('<span  id="'+rand_id+'" class="demo_bubble demo_drop demo_or" data-value="or " ><span class="sel_value">'+translation.translate_or+'</span><i class="demo_hit_me icon-sort-down"></i><span class="demo_options"><ul><li class="demo_change_val" data-value="or" data-text="'+translation.translate_or+'">'+translation.translate_or+'</li><li class="demo_change_val" data-value="and" data-text="'+translation.translate_and+'">'+translation.translate_and+
'</li></ul></span><i class="demo_remove_filter icon-remove"></i></span>');"and"==a&&$("#keyword_filter").append('<span  id="'+rand_id+'" data-string="sel_value" class="demo_bubble demo_drop demo_and" data-value="and " ><span class="sel_value">'+translation.translate_and+'</span><i class="demo_hit_me icon-sort-down"></i><span class="demo_options"><ul><li class="demo_change_val" data-value="and" data-text="'+translation.translate_and+'">'+translation.translate_and+'</li><li class="demo_change_val" data-value="or" data-text="'+
translation.translate_or+'">'+translation.translate_or+'</li></ul></span><i class="demo_remove_filter icon-remove"></i></span>');"("==a&&$("#keyword_filter").append('<span  id="'+rand_id+'" class="demo_bubble  demo_group" data-option="("><span class="sel_value">'+translation.translate_group+'</span><i class="demo_remove_filter icon-remove"></i></span>');")"==a&&$("#keyword_filter").append('<span  id="'+rand_id+'" class="demo_bubble  demo_end_group" data-option=")"><span class="sel_value">'+translation.translate_end_group+
'</span><i class="demo_remove_filter icon-remove"></i></span>');if(-1!=a.indexOf("language")){splitValue=a.split(" ");splitValue[2]=splitValue[2].replace(/'/g,"");for(n in languages)languages[n].token.toLowerCase()==splitValue[2].toLowerCase()&&(tokenValue=languages[n].token.toLowerCase());tokenValue&&("!="==splitValue[1]?$("#keyword_filter").append('<span id="'+rand_id+'" class="demo_bubble demo_contains" data-option="language != " data-value="'+splitValue[2]+'">'+translation.translate_language_is_not+
'<span class="demo_drop demo_bubble_text"><select class="demo_options" id="languages">'+b+'</select></span><i class="demo_remove_filter icon-remove"></i></span>'):$("#keyword_filter").append('<span id="'+rand_id+'" class="demo_bubble demo_contains" data-option="language = " data-value="'+splitValue[2]+'">'+translation.translate_language_is+'<span class="demo_drop demo_bubble_text"><select class="demo_options" id="languages">'+b+'</select></span><i class="demo_remove_filter icon-remove"></i></span>'),
...
" - "+(new Date(this.end)).add({days:-1}).toString("MMMM d, yyyy"));return this}});Cloudwalkers.Views.Widgets.MessagesCounters=Cloudwalkers.Views.Widgets.Widget.extend({entries:[],events:{"click a[href]":"updatesettings"},initialize:function(a){a.color||(this.options.color=this.color);this.list=a.channel[a.source];this.listenToOnce(a.channel,"sync",this.updatedcounters.bind(this));a.channel.fetch();this.rendercounters()},updatedcounters:function(a){this.options.channel=a;this.options.channel[this.options.source].models=this.options.channel.get(this.options.source);for(n in this.options.channel[this.options.source].models)this.options.channel[this.options.source].models[n]=
new Cloudwalkers.Models.Stream(this.options.channel[this.options.source].models[n]);this.list=this.options.channel[this.options.source];this.rendercounters()},rendercounters:function(){if(this.list)for(n in this.list.models)if(this.list.models[n].count=0,this.listenTo(this.list.models[n],"change",this.render),this.listenTo(this.list.models[n],"change",this.negotiateFunctionalities),this.list.models[n].get("counters"))"outgoing"==this.options.channel.get("type")?this.list.models[n].count=this.list.models[n].get("counters").total.scheduled.messages.total:
this.list.models[n].count=this.list.models[n].get("counters").recent.incoming.any.unread;else if(this.list.models[n].channels)for(k in this.keywordchannels=this.list.models[n].channels.models,this.keywordchannels){this.keywordstreams=this.keywordchannels[k].streams.models;for(j in this.keywordstreams)if(this.keywordstreams[j].get("counters"))for(i in this.counters=this.keywordstreams[j].get("counters").MESSAGE,this.counters)"UNREAD"==this.counters[i].type&&"TOTAL"==this.counters[i].interval&&(this.list.models[n].count+=
parseInt(this.counters[i].amount));this.list.models[n].count=this.keywordchannels[k].streams.models.get("counters").recent.incoming.any.unread}this.trigger("view:update")},render:function(){var a={list:[]};$.extend(a,this.options);this.list&&(this.list.comparator=function(a,c){return c.count-a.count},this.list.sort(),this.list.each(function(b){var c=b.attributes,e=a.typelink?a.typelink+"/"+(b.get("hasMessages")?"messages":"notifications"):a.link?a.link:"#"+a.type+"/"+a.channel.id+"/"+b.id;a.list.push({id:c.id,
name:c.name,url:e,count:b.count,icon:c.network?c.network.icon:a.icon})}));this.$el.html(Mustache.render(Templates.messagescounters,a));return this},updatesettings:function(a){if("streams"!=this.options.source&&"outgoing"!=this.options.source)return null;a=this.list.get($(a.currentTarget).data("stream"));var b=a.get("childtypes")[0]+"s";"outgoing"==this.options.source&&(b="scheduled");var c=Cloudwalkers.Session.viewsettings(b);c.streams=[a.id];Cloudwalkers.Session.viewsettings(b,c)},negotiateFunctionalities:function(){this.$el.find(".scroller").length&&
