...
this.draft.get("streams").length?this.draft.id?this.draft.save({variations:this.draft.get("variations"),streams:this.draft.get("streams"),status:"scheduled",update:!0},{patch:!0,endpoint:"original",success:this.thankyou.bind(this)}):this.draft.save({status:"scheduled"},{success:this.thankyou.bind(this)}):this.save("scheduled")},postaction:function(){var a=[];this.$el.find(".action-tabs div").each(function(){a.push($(this).data("stream"))});if(!a.length)return Cloudwalkers.RootView.information("Not saved",
"Select at least 1 network",this.$el.find(".modal-footer"));if(0<=this.options[this.type].indexOf("editor")&&!this.draft.get("body").html)return Cloudwalkers.RootView.information("Not saved","Provide some text first",this.$el.find(".modal-footer"));this.disablefooter();var b=this.reference.actions.create({streams:a,message:this.draft.get("body").html,actiontype:this.type},{success:this.thankyou.bind(this)});this.loadListeners(b,["request:action","sync"]);b.trigger("request:action")},thankyou:function(){var a=
Mustache.render(Templates.thankyou);setTimeout(function(){this.$el.addClass("switch-mode").addClass("thanks");this.$el.find(".switch-container").append(a);setTimeout(function(){this.$el.modal("hide")}.bind(this),1E3)}.bind(this),400)},disablefooter:function(){this.$el.find(".modal-footer .btn").attr("disabled",!0)},invalid:function(a,b){Cloudwalkers.RootView.alert(a.get("title")+" "+b)},isscrolling:function(){if(this.$el.find(".stream-tabs").length)return this.$el.find(".stream-tabs")[0].scrollWidth>
this.$el.find(".stream-tabs").width();if(this.$el.find(".action-tabs").length)return this.$el.find(".action-tabs")[0].scrollWidth>this.$el.find(".action-tabs").width()}});Cloudwalkers.Views.Preview=Backbone.View.extend({id:"preview",events:{},networkclasses:{facebook:"fb",twitter:"twt","google-plus":"gp",linkedin:"li"},events:{"click #viewsummary":"togglesummary"},initialize:function(a){a&&$.extend(this,a);$.extend(this.model.attributes,this.model.getvariation(this.streamid));this.model.attributes.profile=Cloudwalkers.Session.getStream(this.streamid).get("profile");this.network=Cloudwalkers.Session.getStream(this.streamid).get("network").token},render:function(){var a=
...
return this},unfollow:function(){this.model.trigger("unfollow",this.model);this.model.parent=Cloudwalkers.Session.getAccount();this.model.save({following:!1},{patch:!0});this.remove()}});Cloudwalkers.Views.Editor=Backbone.View.extend({id:"editor",className:"clearfix",oldUrl:"",urldata:{},currenturl:!1,urlprocessing:!1,limit:null,content:"",pos:0,posmap:[],restrictedstreams:{twitter:140,linkedin:700},events:{"update:content":"render","update:limit":"renderlimit","append:content":"append","keydown #compose-content":"listentochange","paste #compose-content":"listentochange","blur #compose-content":"endchange","click #swaplink":"swaplink","keydown #composeplaceholder":"updatecontainer",
"mouseup #compose-content":"savepos"},xtrimmable:/<[^>]*>|&nbsp;|\s/g,xurlbasic:/http|[w]{3}/g,xshortens:/http|[w]{3}/g,xurlpattern:/(^|\s|\r|\n|\u00a0)((https?:\/\/|[w]{3})?[\w-]+(\.[\w-]+)+\.?(:\d+)?(\/\S*)?)(\s|\r|\n|\u00a0)/gi,initialize:function(a){a&&$.extend(this,a);this.listenTo(Cloudwalkers.Session.UrlShortener,"sync",this.parseurl);this.listenTo(this.parent,"update:stream",function(a){this.togglecontent(a,!0)}.bind(this))},render:function(a){void 0!==a&&(this.content=a);a=Math.min.apply(Math,
_.values(this.restrictedstreams));this.restrictedstreams["default"]=a;this.$el.html(Mustache.render(Templates.editor,{limit:a}));this.limit=a;this.$contenteditable=this.$el.find("#compose-content").eq(0);this.contenteditable=this.$contenteditable.get(0);this.document=this.contenteditable.ownerDocument||this.contenteditable.document;this.win=document.defaultView||document.parentWindow;this.$contenteditable.html(this.content);this.content&&this.listentochange();return this},savepos:function(a){a=a.target.tagName;
"I"!=a&&"SHORT"!=a&&(this.pos=this.cursorpos())},listentochange:function(a){a=this.$contenteditable.text();var b=this.limit-this.$contenteditable.text().length;this.pos=this.cursorpos();this.content!==a&&(!this.currenturl&&this.listentourl(a)&&this.processurl(),0>=b&&this.greyout(b,this.limit));this.updatecounter(b);this.content=this.$contenteditable.text();this.isdefault&&(this.$contenteditable.removeClass("withdefault"),this.isdefault=!1);this.trigger("change:content",this.content)},listentourl:function(a,
b){var c=this.win.getSelection(),e=this.document.createRange(),f,g,h;e.selectNodeContents(this.$contenteditable.get(0));f=this.parsenodes(e.startContainer.childNodes);if(this.currenturl)return f=e.startContainer.childNodes[f],g=f.textContent.replace(/&nbsp;/gi,""),g=g.indexOf(this.currenturl),h=g+this.currenturl.length,e.setStart(f,g),e.setEnd(f,h),c.removeAllRanges(),c.addRange(e),this.contenteditable.designMode="on",document.execCommand("createLink",!1,this.currenturl),this.contenteditable.designMode=
"off",f=document.createTextNode(" \u200b\u200b"),e.insertNode(f),this.$contenteditable.find("a").after(f),e.setStartAfter(f),c.removeAllRanges(),c.addRange(e),!0},processurl:function(){this.$contenteditable.find("a").attr("contenteditable",!1);this.filterurl(this.currenturl)},parsenodes:function(a){var b=null;$.each(a,function(a,e){var f=!1,g=e.wholeText?e.wholeText:e.innerHTML;g&&(f=g.match(this.xurlpattern));if(f)return b=a,this.currenturl=f[0],!0}.bind(this));return b},filterurl:function(a){var b=
a.match(this.xurlpattern);b&&!this.urlprocessing&&(this.urlprocessing=!0,b.forEach(function(a){Cloudwalkers.Session.UrlShortener.fetch({q:a.trim(),error:this.releaseurlprocessing})}));return a},greyout:function(a,b){var c=this.win.getSelection(),e=this.document.createRange(),f=this.cursorpos(),g,h;this.content.length>=this.$contenteditable.text().length&&this.removegrey();e.selectNodeContents(this.$contenteditable.get(0));g=e.endContainer.childNodes[e.endContainer.childNodes.length-1];h=this.cursorpos(this.limit,
!0);e.setStart(h.node,h.offset);e.setEndAfter(g);c.removeAllRanges();c.addRange(e);this.contenteditable.designMode="on";document.execCommand("backColor",!1,"#fcc");this.contenteditable.designMode="off";this.mergechars();this.cursorpos(f)},removegrey:function(){var a=this.win.getSelection(),b=this.document.createRange();b.selectNodeContents(this.$contenteditable.find("span").get(0));a.removeAllRanges();a.addRange(b);this.contenteditable.designMode="on";document.execCommand("removeFormat",!1,null);
this.contenteditable.designMode="off"},mergechars:function(){$.each(this.$contenteditable.find("span"),function(a,b){$(b).html($(b).text())}.bind(this))},parseurl:function(a){var b="<short contenteditable='false' data-url='"+a.longurl+"'>"+a.get("shortUrl")+"<i class='icon-link' id='swaplink'></i></short>",c=this;this.currenturl=a.longurl;this.shorturl=a.get("shortUrl");this.$contenteditable.find("a").replaceWith(b);this.trigger("change:content",this.content);a='<div><a href="'+this.currenturl+'" class="oembed"></a></div>';
this.$el.find("#out").empty().html(a);this.$el.find(".oembed").oembed(null,null,this.embed).each(function(){this.def.done(function(){c.$el.find("#out").addClass("expanded")})})},cursorpos:function(a,b){var c,e;if(void 0===a)a=0,void 0!==this.win.getSelection?(e=this.win.getSelection().getRangeAt(0),c=e.cloneRange(),c.selectNodeContents(this.contenteditable),c.setEnd(e.endContainer,e.endOffset),a=c.toString().length):(c=doc.selection)&&"Control"!=c.type&&(e=c.createRange(),c=document.body.createTextRange(),
c.moveToElementText(this.contenteditable),c.setEndPoint("EndToEnd",e),a=c.text.length);else{this.getnode(this.$contenteditable[0],a);var f=this.currentnode;if(b)return{node:f.node,offset:f.offset};e=this.document.createRange();c=this.win.getSelection();e.setStart(f.node,f.offset);e.collapse(!0);c.removeAllRanges();c.addRange(e)}return a},getnode:function(a,b,c){$.each(a.childNodes,function(a,f){if(c){if(f.nodeName==c)if(f.childNodes.length)this.getnode(f,null,c);else return this.nextnode=f,!1}else{var g=
f.textContent.length;return g>=b?(f.childNodes.length?this.getnode(f,b):this.currentnode={node:f,offset:b},!1):b-=g}}.bind(this))},updatecounter:function(a){var b=this.$el.find(".limit-counter");20<=a&&b.removeClass().addClass("limit-counter");20>a&&b.removeClass().addClass("limit-counter").addClass("color-notice");0>a&&b.removeClass().addClass("limit-counter").addClass("color-warning");b.empty().html(a)},swaplink:function(){var a=this.$contenteditable.find("short").data("url").replace(/\s/g,"")==
this.currenturl.replace(/\s/g,""),b="<short contenteditable='false' data-url='"+this.shorturl+"'>"+this.currenturl+"<i class='icon-link' id='swaplink'></i></short>",c="<short contenteditable='false' data-url='"+this.currenturl+"'>"+this.shorturl+"<i class='icon-link' id='swaplink'></i></short>",e=this.$contenteditable.text().length;a?this.$contenteditable.find("short").replaceWith(b):this.$contenteditable.find("short").replaceWith(c);b=this.$contenteditable.text().length-e;a=a?this.$contenteditable.text().indexOf(this.currenturl):
this.$contenteditable.text().indexOf(this.shorturl);this.pos>=a?this.cursorpos(this.pos+b):this.cursorpos(this.pos);this.pos=this.cursorpos();this.trigger("change:content",this.content)},togglecontent:function(a,b){if(a)var c=_.isNumber(a)?a:null,e=_.isObject(a)?a.html:null,c=c?Cloudwalkers.Session.getStream(c).get("network").token:null;this.network=c?c:"default";c&&!e?(this.$contenteditable.empty().html(this.draft.get("body").html),this.$contenteditable.addClass("withdefault"),this.isdefault=!0):
(a?(e||(e=""),this.$contenteditable.empty().html(e)):this.$contenteditable.empty().html(this.draft.get("body").html),this.$contenteditable.removeClass("withdefault"));this.limit=this.restrictedstreams[this.network];this.updatecounter(this.restrictedstreams[this.network]-this.$contenteditable.text().length)},settextdefault:function(){var a,b;a=this.win.getSelection();b=this.document.createRange();b.selectNodeContents(this.$contenteditable.get(0));a.removeAllRanges();a.addRange(b);this.contenteditable.designMode=
"on";document.execCommand("foreColor",!1,"#CCCCCC");this.contenteditable.designMode="off";a.collapse(this.$contenteditable.get(0),0);b.collapse(!1)},addoetitle:function(a){},addoecontent:function(a){a=a.currentTarget.parentElement.parentElement.innerText;var b=this.$contenteditable.html();this.$contenteditable.html(b+"<br/>"+a);this.updatecontainer();this.trigger("contentadded")},addoeimg:function(a){a=this.$el.find('[data-type="image"] img').get(0).src;this.trigger("imageadded",{type:"image",data:a,
name:a})}});Cloudwalkers.Widget=Backbone.View.extend({title:"...",color:"blue",icon:"cloud",events:{"click .portlet-title.line":"collapse"},initialize:function(){this.bind("destroy",this.destroy)},innerRender:function(){this.$el.addClass("inner-empty")},render:function(){this.$el.html(Mustache.render(Templates.widget,{title:this.options.title|this.title,color:this.options.color|this.color,icon:this.options.icon|this.icon}));"auto"==this.options.height&&this.$el.find(".scroller").remove();"undefined"!=typeof this.options.counter&&
